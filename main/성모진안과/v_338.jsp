...
<style>
    ...
    * {font-family: "Paperlogy", sans-serif; box-sizing: border-box;}
    ...
    .count-area .count-box {position: absolute; width: 64.63%; left: 50%; transform: translateX(-50%); top: 5%;}
    .count-area .count {position: absolute; top: 25%; font-size: 275%; color: #f0ff00; font-family: 'Paperlogy'; font-weight: 600; left: 49.5%; letter-spacing: -0.04em; width: 7.5rem; text-align: center; line-height: 1;}
    ...
    #page_landing_c .wrap_form {background-color: #10019a; padding: 81px 5.649% !important;}
    #page_landing_c .wrap_curd {background-color: transparent;}
    #page_landing_c .wrap_curd .question_container {padding-top: 0 !important; padding-bottom: 5%; background: url("//static.savemkt.com/event/v_${eventSeq}/event_main_03.png") no-repeat center top / 100% 100%;}
    #page_landing_c .wrap_curd .question_container .q_text {padding-top: 7.846%; width: 76.884%;}
    /* #page_landing_c .wrap_curd .question_box {} */
    #page_landing_c .wrap_curd .question_box .q_text {padding: 0 7.532%; width: 100%;}

    /* user db입력칸 (이름) */
    #page_landing_c .wrap_curd .q_select {display: flex; align-items: center; justify-content: space-between; column-gap: 15px; padding: 0 7.532%;}
    #page_landing_c .description p, #page_landing_c .description .ad_txt {text-align: center; font-family: 'Paperlogy';}
    
    #page_landing_c .description:not(.top-desc) {display: flex; align-items: center; justify-content: center; width: 100%; padding: 2.37% 3.9%; column-gap: 25px; text-align: center; font-family: 'Paperlogy'; border-top: 1px solid #a69e9e; background-color: #b7b8bb;}
    #page_landing_c .description.top-desc .ad_txt {margin: 3% auto;}
    ...
    #page_landing_c .question_box > div:not(.formContents) + div:not(.formContents) {margin-top: 7.655%; padding: 0 7.532%;}
    ...
    #page_landing_c .agBox {text-align: center; color: #000; font-size: 240%; margin: 4% auto; font-family: 'Paperlogy'; font-weight: 500;}
    #page_landing_c .agBox .legend {max-width: max-content;}
    #page_landing_c .agBox .btn-agreement {line-height: 1; text-decoration: underline; font-weight: 600;}

    .btn_box {display: flex; align-items: center; justify-content: space-between; column-gap: 15px; padding: 0 7.532%;}
    ...
    /* 설문값, 동의, 미동의 버튼 공통 */
    #page_landing_c .question_box .q_select label {background-color: #fff; width: 100%;}
    ...
    /* 이름, 연락처 공통 */
    #page_landing_c .question_box > div:not(.formContents)[class^="user_"] + div:not(.formContents)[class^="user_"] {margin-top: 14px;}
    /* #page_landing_c .question_box.form-box  {margin-top: 0;}  */
    ...
    #page_landing_c .inp {font-size: 160%; line-height: 1; border: 1px solid #10019a; color: #00003d; min-height: 34px; padding: 2.674% 3%; box-sizing: border-box; margin-left: 0; border-radius: 2rem; transition: 0s; text-align: center;}
    ...
    #page_landing_c .wrap_curd .submit {margin: 0 auto; padding: 0; width: 64.5%;}
...
@media screen and (max-width: 480px){
    #page_landing_c .wrap_form {padding: 41px 5.649% !important;}
    .count-area .count {top: 28%; width: 15%; font-size: 100%;}
    #page_landing_c .agBox {font-size: 100%;}
    #page_landing_c .description:not(.top-desc) {column-gap: 7px;}
    #page_landing_c .description .ad_txt {font-size: 80%;}
    #page_landing_c .inp {font-size: 110%; padding: 2.674% 3% !important; border-radius: 1rem;}
    #page_landing_c .description .target,
    #page_landing_c .description p {font-size: 75%;}
}
                ...
                <div class="formGroup">
                    <div class="form_inner">
                        <div class="question_container">
                            ...
                            <div class="agBox">
                                <a href="javascript:void(0);" class="btn-agreement"> 개인정보 처리방침</a>에<br />동의하시면 혜택 참여 가능합니다.
                            </div>
                            <div class="description top-desc">
                            ...
                            <div class="question_box form-box">
                                <div class="q_text img-area" style="width: 80%;">
                                    <img src="//static.savemkt.com/event/v_${eventSeq}/txt_02.png">
                                </div>
                                <div class="user_name">
...
<script>
	...
	function fnForm(formId){
		...
		if (!selectedRadio2) {
			alert("수술 이력 항목을 선택해주세요.");
			return;
		} else {
			procForm.querySelector("input[name='add1']").value = selectedRadio2.value;
		}

		let selectedRadio3 = procForm.querySelector('input[name="tadd2"]:checked');
		if (!selectedRadio3) {
			alert("거주지역 항목을 선택해주세요.");
			return;
		} else {
			procForm.querySelector("input[name='add2']").value = selectedRadio3.value;
		}
