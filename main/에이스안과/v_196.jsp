...
/* 비디오 영역 */
.form .video-area {position: relative; padding-top: 62.58%; border: 8px solid #fff; border-right: 0; border-left: 0;}
...
#page-1 {padding-top: 7.34%; background: url('//static.savemkt.com/event/v_${eventSeq}/bg.jpg') no-repeat center top / 100% 100%;}
...
.page .paging button img {width: 61.46% !important; margin: 0 auto; animation: pulsating 0.8s linear infinite;
    ...
    .form .description p, .form .description .ad_txt, .form .description span {font-family: 'Pretendard'; font-weight: 600; font-size: 125%;}
    ...
    .form .question_box .q_select label{width:100%;padding: 1% 0; cursor: pointer; background: #e2e2e2; border-radius: 1.8rem; font-size: 238%; font-weight: 600; font-family: 'Pretendard';}
    ...
    .form .table_box input {background: #e2e2e2; border-radius: 1.8rem; font-size: 2.8rem; border: none; background: transparent; width: 100%; padding: 1.5rem 0 1.5rem 2rem; font-family: 'Pretendard'; font-weight: 600; text-align: center;}
    .form .table_box input::placeholder{color: rgba(0, 0, 0, 0.7); text-align: center; font-family: 'Pretendard'; font-weight: 500;}
    ...
    /* 개인정보 처리방침 */
    .agBox {display: flex; align-items: center; justify-content: center; margin-top: -5%; padding-bottom: 11.4%; font-family: 'GmarketSans'; font-weight: 500; font-size: 1.4rem; line-height: 1; color: #fff;}
    ...
    @media screen and (max-width: 786px) {
        ...
        #page_landing_c .form .table_box input {padding: 1rem; font-size: 1.4rem; text-align: center;}
        #page_landing_c .form .table_box input::placeholder {text-align: center;}
        ...
        [class^="popup-event"] {padding: 20px 45px 20px;}
                ...
                <div class="formContents"> 
                    ...
                    <section class="page" id="page-2">
                        <div class="inner">
                            ...
                            <div class="question_box">
                                <div class="q_select">
                                    <label><input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(3,$(this))" name="tadd1" value="예">예</label>
                    ...
                    <section class="page" id="page-3">
                        <div class="inner">
                            ...
                            <div class="img-area poster_04"><img src="//static.savemkt.com/event/v_${eventSeq}/gage_02.png"></div>
                            <div class="question_box">
                                <div class="q_select">
                                    <label><input type="radio" name="tadd2" value="예">예</label>
                                    <label><input type="radio" onclick="setTimeout(show4pg, 100)" onclick="pageFuc(4,$(this))" name="tadd2" value="아니오">아니오</label>
                                </div>
                            </div>
                    ...
                    <div class="popup-event">
                        <div class="img-area">
                            <img src="//static.savemkt.com/event/v_${eventSeq}/pop_txt_02.png">
                        </div>
                        <div class="btn-box">
                            <button type="button" class="btn-confirm"></button>
                        </div>
...
<script>
    ...
    // popup-event > 확인 버튼
    $('.popup-event .btn-confirm').on('click', function () {
        $('.overlay, .popup-event').hide();
    ...
    function show3pg() {
        ...
        animation03.from('#page-3 .poster_03', {x: +200, opacity: 0, duration: 0});
        animation03.from('#page-3 .poster_04', {x: +200, opacity: 0, duration: 0});
    ...
    function show4pg() {
        ...
        // animation03.to('#page-2 .next_btn_inQuestion', {x: -100, opacity: 0});
        // animation03.to('#page-2', { display: 'none' });
        animation03.to('#page-3 .poster_03', { x: -100, opacity: 0, delay: 0.2, duration: 0.2, ease: "power1.out"}, 0);
        animation03.to('#page-3 .poster_04', { x: -100, opacity: 0, delay: 0.4, duration: 0.2, ease: "power1.out"}, 0);
        animation03.to('#page-3 .poster_05', { x: -100, opacity: 0, delay: 0.6, duration: 0.2, ease: "power1.out"}, 0);
        animation03.to('#page-3 .poster_06', { x: -100, opacity: 0, delay: 0.8, duration: 0.2, ease: "power1.out"}, 0);
