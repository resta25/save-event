...
.page .paging button {position: relative; width: 100%; height: 160px; background: url('//static.savemkt.com/event/v_${eventSeq}/btn_newsb_01.png') no-repeat center center / 100% 100%; margin: 0 auto; padding: 0% 0;}
.page .paging button img {width: 60% !important; margin: 0 auto; animation: pulsating 0.8s linear infinite; -webkit-animation: pulsating 0.8s linear infinite;}
...
#page-1 .poster_02 > .img-area {width: 79.28%; margin: 0 auto; padding-bottom: 6.009%;}
...
#page-3 .sm-txt {font-size: 60% !important; font-weight: 500; padding: 0 !important; }
#page-3 .sm-txt::before, #page-3 .sm-txt::after {display: none;}
...
.wrap_form .agBox {margin-bottom: 0 !important;}
.wrap_form .agBox a,
.wrap_form input[type="checkbox"] + span, .wrap_form input[type="radio"] + span {font-size: 16px !important;}
...
@media screen and (max-width: 786px) {
    ...
    .wrap_form .agBox a,
    .wrap_form input[type="checkbox"] + span, .wrap_form input[type="radio"] + span {font-size: 14px !important;}
...
@media screen and (max-width: 500px){
    ...
    .wrap_form .agBox a,
    .wrap_form input[type="checkbox"] + span, .wrap_form input[type="radio"] + span {font-size: 12px !important;}
...
<body id="page_landing_c" class="loaded">
    <main>
        <div id="wrap">
            <div class="form wrap_form">
                <form class="" id="form-1" method="POST" accept-charset="utf-8"> 
...
“회사”는 서비스 향상을 위하여 아래와 같이 개인정보 처리업무를 위탁하고 있으며, 관계 법령에 따라 위탁계약 시 개인정보가 안전하게 관리될 수 있도록 필요한 사항을 규정하고 있습니다.

“회사”의 개인정보 처리업무 수탁업체 및 위탁업무 내용은 아래와 같습니다.
