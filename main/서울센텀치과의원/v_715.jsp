...
.form input[type="checkbox"] + span, .form input[type="radio"] + span {padding: 1px 4px 0 35px;}
.form input[type="checkbox"] + span:before, .form input[type="radio"] + span:before {width: 20px; height: 20px; border: 2px solid #3f3f3f;}
...
.branch_box .title {margin-right: 5%; color: #3f3f3f;}
.branch_box label span {color: #3f3f3f;}
...
<div class="agreeModalBox">
	...
	<div class="newAgreement">
        ...
        <div class="button"><a href="${resVo.homepageUrl}" target="_agreement" target="_blank">개인정보처리방침 확인하러가기</a></div>
                ...
                <div class="television">                    
                    <div class="screen">
                        <div class="formGroup">
                            <div class="user_info">
                                <div class="user_name">
                                    <input type="text" name="name" id="name" class="inp" required autocomplete="off" placeholder="성함을 입력해주세요."/>
                                </div>
