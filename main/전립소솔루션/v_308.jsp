...
.form .table_box input {border: 7px solid #be1818; text-align: center; border-radius: 2rem; font-size: 4rem; background: transparent; width: 100%; padding: 1.5rem 2rem; font-family: 'Paperlogy'; font-weight: 500;}
...
/* 동의 박스 (전체/필수/선택) */
.agree_box {width: 50%; margin: 0 auto 4%; padding: 0 2%; font-family: 'Paperlogy'; box-sizing: border-box;}
            ...
            <div class="form">
                ...
                <div class="formContents"> 
                    ...
                    <div class="agree-popup" id="agreePopup1">
                        ...
                        <div class="ag-body">
                            <div class="intro">'뷰티트렌드'는 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다. 회사는 개인정보취급방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다. 회사는 개인정보취급방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.</div>
                            <ol class="toc">
                                <li>수집하는 개인정보 항목</li>
                                ...
                                <li>개인정보 제공</li>
                                <li>개인정보의 처리 위탁</li>
                                <li>개인정보 제3자에게 정보 제공</li>
                                <li>이용자 및 법정대리인의 권리와 그 행사방법</li>
                                <li>개인정보 자동 수집 장치의 설치, 운영 및 그 거부에 관한 사항</li>
                                <li>개인정보에 관한 민원서비스</li>
                            </ol>

                            <p class="section-title">1. 수집하는 개인정보 항목</p>
                            <div class="section-content">회사는 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
                            - 수집항목 : 이름, 나이, 성별, 연락처
                            - 개인정보 수집방법 : 상담신청, 이벤트 참여</div>

                            <p class="section-title">2. 개인정보의 수집 및 이용목적</p>
                            <div class="section-content">회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다.
                            - 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 상담, 요금정산, 구매 및 요금결제, 물품배송 또는 청구지 등 발송</div>

                            <p class="section-title">3. 개인정보의 보유 및 이용기간</p>
                            <div class="section-content">원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 예외없이 해당 정보를 지체 없이 파기합니다. 단, 관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 아래와 같이 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.
                            - 보존 항목 : 이름, 나이, 성별, 휴대전화번호
                            - 보존 근거 : 전자상거래등에서의 소비자보호에 관한 법률
                            - 보존 기간 : 5년
                            - 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년 (전자상거래등에서의 소비자보호에 관한 법률)
                            - 상담 참여시 : 이벤트 페이지에 별도 명시한 수집 동의받은 날로부터 동의받은 기간 동안 보관</div>

                            <p class="section-title">4. 개인정보의 파기절차 및 방법</p>
                            <div class="section-content">회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체없이 파기합니다. 파기절차 및 방법은 다음과 같습니다.
                            ...
                            - 파기방법 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.</div>

                            <p class="section-title">5. 개인정보 제공</p>
                            <div class="section-content">회사는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.
                            - 이용자들이 사전에 동의한 경우
                            - 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우</div>

                            <p class="section-title">6. 개인정보의 처리 위탁</p>
                            <div class="section-content">회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
                            - 수탁자 : (주)한걸음컴퍼니
                            - 위탁업무 : 상담 신청자 개인정보를 서버에 수집, 보관, 처리, 전달, 파기하는 업무
                            - 보유 및 이용기간 : 고객 동의 철회 또는 위탁 업무 종료시까지</div>

                            <p class="section-title">7. 개인정보 제3자에게 정보 제공</p>
                            <div class="section-content">정보주체의 개인정보를 개인정보의 처리 목적에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 개인정보보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공하고 그 이외에는 정보주체의 개인정보를 제3자에게 제공하지 않습니다.
                            - 제공 받는 자 : CJ웰케어(주)
                            - 제공 목적 : 1. 제품 상담 및 판매 2. 이벤트 등 광고성 정보 전달
                            - 제공 항목 : 성명, 성별, 나이, 연락처, 주문이력, 상담내용
                            - 보유 및 이용기간 : 고객 동의 철회 또는 제3자 제공 동의 철회 시까지</div>

                            <p class="section-title">8. 이용자 및 법정대리인의 권리와 그 행사방법</p>
                            <div class="section-content">귀하가 개인정보의 오류에 대한 정정을 요청하신 경우에는 정정을 완료하기 전까지 당해 개인정보를 이용 또는 제공하지 않습니다.</div>

                            <p class="section-title">9. 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</p>
                            <div class="section-content">쿠키 등 인터넷 서비스 이용 시 자동 생성되는 개인정보를 수집하는 장치를 운영하지 않습니다.</div>

                            <p class="section-title">10. 개인정보에 관한 민원서비스</p>
                            <div class="section-content">회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보관리책임자를 지정하고 있습니다. <br />
...
<script>
    ...
    document.addEventListener('keydown', function(e) {
        if (e.key === 'Escape' || e.keyCode === 27) closeAgreePopup();
    });
