...
<style>
    ...
    * {font-family: "Noto Sans KR", sans-serif; box-sizing: border-box;}
    ...
    #page_landing_c  .img-area .btm_box2 {bottom: 3%;}
    ...
    #page_landing_c .wrap_form {background-color: #fff; padding: 123px 34px 30px !important;}
    ...
    #page_landing_c .question_box {width: 71.627906%; margin: 10% auto 4%;}
    ...
    #page_landing_c .legend {flex-shrink: 0; position: relative; display: block; width: 25%; height: 35px; font-size: 167%; font-weight: 500; line-height: 1; letter-spacing: -1.78px; color: #000; text-align: justify;}
    #page_landing_c .legend::after {content: ''; display: inline-block; width: 100%;}
    #page_landing_c .agBox {text-align: center; display: flex; align-items: center; justify-content: center; color: #000; font-size: 180%; margin: 7% auto 3%;}
