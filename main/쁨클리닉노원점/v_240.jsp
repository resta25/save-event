            ...
            <div class="wrap_form">
                <form class="wrap_curd" id="form-1" method="POST" accept-charset="utf-8">
                    ...
                    <ul class="layout_add02">
                        <li>
                            <label><input type="radio" name="tadd1" value="넓어진 모공" class="answer">넓어진 모공</label>
                            <label><input type="radio" name="tadd1" value="흉터" class="answer">흉터</label>
                            <label><input type="radio" name="tadd1" value="피부결" class="answer">피부결</label>
