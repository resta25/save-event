...
main .page-title {height: 100%; line-height: 1; padding: 0; background-color: #000;}
main .page-title strong {color: #008d8f;}
.inner {padding: 14.4rem 7.2rem 20.8rem; background-color: #000;}
.intro-txt {width: 90.918803%; margin: 0 auto 4.9rem;}
.progress {width: 85.897436%; margin: 0 auto 14.2rem;}

.page:not(#page-1){display:none;}

.form, .form .formContents{background-color:#000;}
...
/* add 설문 */
.question_box .question {margin-bottom: 8.6rem; font-size: 5.2rem; color: #fff; font-weight: 300; letter-spacing: -0.01em; text-align: center; line-height: 1;}
#page-2 .question_box .question {margin-bottom: 4.6rem;}
.question_box .question strong {font-weight: 800;}
.question_box .question span {display: block; color: #fff; line-height: 1;}
.question_box .question span + span {margin-top: 2.6rem;}
.question_box .question .lg-txt {font-size: 6.4rem; font-weight: 300;}
.question_box .question .lg-txt strong {font-weight: 800;}
.question_box .question .sm-txt {font-size: 5.2rem; font-weight: 200;}
.question_box .question .sm-txt strong {font-weight: 800;}


.question_box .q_select {display: grid; grid-template-columns: repeat(2, 1fr); column-gap: 3.4rem;}
...
.form-group .item input {padding: 3rem 2rem 4rem; font-size: 5rem; font-family: 'Gmarket Sans', sans-serif; line-height: 1; border: 3px solid #607a7a; border-radius: 2.7rem; letter-spacing: -0.05em; background-color: #fff;}
.form-group .item input::placeholder {color: #b6b6b6; font-family: 'Gmarket Sans', sans-serif;}

/* cta 버튼 */
.form .submit {width: 62.820513%; margin: 3.1rem auto 0; padding: 3.5rem 0; background: url('//static.savemkt.com/event/v_${eventSeq}/btn_newSb.png') no-repeat center center / 100% 100%;}
.form .submit input[type="image"]{display: block; width: 38.265306%; margin: 0 auto; padding: 0; animation: pulsating 0.8s linear infinite; -webkit-animation: pulsating 0.8s linear infinite;}
...
.form .agBox label span {line-height: 1; margin: 0; padding-top: 0; padding-bottom: 0; font-size: 2.6rem; text-align: center; color: #fff;}
.form .agBox a {font-size: 2.2rem; font-weight: 600; color: #fff;}

.notice-area {background-color: #373737; font-weight: 500;  font-size: 1.2rem; text-align: center;}
.notice-area .description {padding: 0.9rem; text-align: center;}
.notice-area .description p,
.notice-area .description span,
.notice-area .description .ad_txt {display: block; font-size: 100%; color: #606060;}
...
/* 실시간 신청 현황 */
.subscribe_container {width: 100%; background: #fff; padding: 0 2rem; border-radius: 1.6rem; margin-top: 11rem;}
.subscribe_bg {background: #f8f8f8; padding: 3.75% 8.5%; border-radius: 20px}
.subscribe_container .title {padding: 3.5rem 0 0; font-size: 3.5rem !important; text-align: center; color: #000; font-weight: 700; font-family: 'GangwonEducationTteontteon';}
.subscribe_container .img-area {width: 40%; margin: 3% auto;}
.subscribe {height: 53rem; padding: 2rem; overflow: hidden;}
...
@media screen and (max-width: 786px) {
    ...
    .inner {padding: 10.4rem 3.2rem 17.8rem;}
    ...
    .notice-area .description p,
    .notice-area .description span,
    .notice-area .description .ad_txt {font-size: 80%;}
}
@media screen and (max-width: 480px){
    .inner {padding: 10.4rem 3.2rem 13.8rem;}
    
    .notice-area .description p,
    .notice-area .description span,
    .notice-area .description .ad_txt {font-size: 50%;}
}
...
<body id="page_landing_c" class="loaded">
    <main>
        ...
        <div id="wrap"> 
            <div class="inner">
                <h2 class="page-title">
                    <div class="img-area intro-txt"><img src="//static.savemkt.com/event/v_${eventSeq}/txt_01.png"></div>
                </h2>
                <div class="form">
...
<script>
    ...
    $('input[name="tadd1"]').on('click', function () {
        if (window.innerWidth <= 480) {
            $('.inner').css({'padding-bottom': '6.64rem'});
        } else if (window.innerWidth <= 768) {
            $('.inner').css({'padding-bottom': '12.64rem'});
        } else {
            $('.inner').css({'padding-bottom': '15.64rem'});
        }
        goToNextPage('#page-1');
    });
