...
/* 초기화 css */
#page_landing_c main {max-width: 1080px; background: transparent !important;}
...
#wrap {max-width: 1080px; letter-spacing: -1px; display: flex; flex-direction: column; background: #fff;}
.form {flex-grow: 1; padding: 0; border: 0;}
.form, .form .formContents {background-color: transparent;}
.form .formContents .inner {padding: 0 2.927%;}
#form-1 {position: relative;}
.formContents {position: absolute; top: 5%; width: 100%;}

.content {padding: 20px 10px;}
.content + .content {border-top: 1px solid #ddd;}
.content * {padding: 8px 10px;}

.count_box {display: flex; align-items: center; min-width: 13%; font-size: 3.8rem; color: #fff; position: absolute; top: 31.5%; left: 58.7%; transform: translateX(-50%);}
.count {flex-shrink: 0; width: 50%; color: #ffde00; font-size: 100% !important; font-family: 'Gmarket Sans', sans-serif; font-weight: 500; line-height: 1; text-align: right;}
...
.form .submit {position: relative; width: 85.466%; height: auto; background: url('//static.savemkt.com/event/v_${eventSeq}/btn_newsb.png') no-repeat center center / 100% 100%; margin: 3% auto; padding: 0;}
.form .submit input[type="image"] {display: block; width: 71.46% !important; margin: 0 auto; padding: 6% 0; animation: pulsating 0.8s linear infinite; -webkit-animation: pulsating 0.8s linear infinite;}

.top-img {position: relative; width: 93.236%; margin: 0 auto;}

.description.footer {width: 100%; padding: 1.115% 0; background-color: #8e8e8e; text-align: center;}
.description.footer * {font-family: 'S-Core Dream', sans-serif !important;}
.description.footer p {line-height: 1.21;}

.form .question,
.form .user_name,
.form .user_phone {display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom: 2%; background-color: #dadada; border-radius: 15px; padding: 25px 35px; box-sizing: border-box;}

.form .legend {flex: 0 0 30%; min-width: 24%; font-size: 300%; font-family: 'Elice DX Neolli', sans-serif; font-weight: 500; line-height: 1; letter-spacing: -0.05em; color: #0a151e; text-align: left;}
.form .question:nth-child(1) .legend {flex: 0 0 50%;}

.form .q_select,
.form .inp {flex: 0 0 70%; display: flex; gap: 10px;}
.form .question:nth-child(1) .q_select,
.form .question:nth-child(1) .inp {flex: 0 0 46.5%;}

.form .q_select label {flex: 1; display: inline-block; flex-shrink: 0; background-color: #fff; padding: 3% 2%; border-radius: 1rem; text-align: center; cursor: pointer; font-size: 187%; font-weight: 500; margin: 0 !important; color: #0a151e; font-family: 'Elice DX Neolli', sans-serif;}
.form .q_select label + label {margin-left: 2.555%;}
.form .q_select label.on {background-color: #fff83d; color: #00385c;}

.form .inp {width: 100% !important; margin-left: 0; font-size: 230%; border: solid 1px #bebebe; border-radius: 10px; background-color: #fff; padding: 2% 3%; min-height: 34px; position: static; box-sizing: border-box; font-family: 'Elice DX Neolli', sans-serif; text-align: left;}
...
.question_container .sub-txt {width: 100%; margin: 0 auto 3%; text-align: center; font-weight: 500; font-size: 150% !important; font-family: 'Gmarket Sans', sans-serif;}
...
.form input[type="checkbox"] + span:before,
.form input[type="radio"] + span:before {top: 50%; width: 14px; height: 14px; border: 2px solid #333; text-align: center; transform: translateY(-50%);}
.form input[type="checkbox"] + span:after,
.form input[type="radio"] + span:after {background-color: transparent; top: 50%; left: 0; width: 20px; height: 10px; margin-top: -5px; border-style: solid; border-color: #333; border-width: 0 0 3px 3px; -moz-transform: rotate(-45deg) scale(0); -ms-transform: rotate(-45deg) scale(0); -webkit-transform: rotate(-45deg) scale(0); transform: rotate(-45deg) scale(0); -moz-transition: none; -o-transition: none; -webkit-transition: none; transition: none;}
...
.form .agBox {position: relative; display: flex; align-items: center; justify-content: center; width: auto; margin: 5% auto 0; text-align: center; font-family: 'Paperlogy'; font-size: 150% !important;}
.form .agBox label span {line-height: 1; margin: 0; padding-top: 0; padding-bottom: 0; font-size: 130%; text-align: center; color: #000; font-family: 'Paperlogy';}
.form .agBox .btn-agreement {font-weight: 700; font-family: 'Paperlogy'; font-size: 90%;}

.form .description.footer {margin-top: 5%;}
.form .description {padding: 1% 0; text-align: center;}
.form .description p,
.form .description span,
.form .description .ad_txt {font-size: 100%;}

.overlay {z-index: 888; position: fixed; top: 0; left: 0; display: none; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.7);}
...
[class^="popup-"] p,
[class^="popup-"] span {text-align: center; font-size: 250%; font-weight: 700; font-family: 'Paperlogy';}
[class^="popup-"] strong {color: #ff0000; font-weight: 700; font-family: 'Paperlogy';}
[class^="popup-"] .btn-box {display: flex; align-items: center; justify-content: center; gap: 1rem; margin-top: 5%;}
[class^="popup-"] .btn-box button {background-color: #18609d; color: #fff; width: 150px; height: 50px; font-size: 125%; font-weight: 700; border-radius: 0.5rem; font-family: 'Paperlogy';}
[class^="popup-"] .btn-box button.btn-out {background-color: #022848;}
.popup-valid .btn-box button {width: 65%; margin: 0 auto; font-size: 175%; font-weight: 500; font-family: 'Paperlogy';}
...
@media screen and (max-width: 768px) {
    /* .form .legend {font-size: 190%;}
    .form .q_select label {font-size: 117%;}
    ...
    .question_container .sub-txt {font-size: 12px;} */
    .form .legend {font-size: 210%;}
    #page_landing_c input:not( [type="checkbox"], [type="radio"], [type="range"] ), select {
        padding: 2% 3%;
    }
    #page_landing_c .form .submit input[type="image"] {padding: 6% 0;}
}
@media screen and (max-width: 480px) {
    .form .q_select label {font-size: 130%; border-radius: 0.5rem;}
    .form .question:nth-child(1) .q_select,
    .form .question:nth-child(1) .inp {flex: 0 0 41.5%;}
    ...
    .description.footer #target {font-size: 75%;}
        ...
        <div id="wrap">
            <div class="form">
                <form id="form-1" method="POST" accept-charset="utf-8">
                    <div class="img-area">
                        <img src="//static.savemkt.com/event/v_${eventSeq}/event_main_01.jpg" alt="">
                    </div>
                    <div class="formContents">
                        <div class="inner">
                            ...
                            <div class="question_container">
                                <div class="img-area"><img src="//static.savemkt.com/event/v_${eventSeq}/txt.png"></div>
                                ...
                                <div class="question_box">
                                    ...
                                    <div class="user_name">
                                        ...
                                        <input type="text" name="name" id="name" class="inp" placeholder="이름을 입력해주세요" required autocomplete="off">
                                    </div>
    
                                    <div class="user_phone">
                                        <span class="legend">연락처</span>
                                        <input type="tel" name="phone" id="phone" class="inp" value="010-" required maxlength="11" autocomplete="off">
                                    </div>
                                </div>
                            </div>
...
<script>
	...
	function returnComment(resultData, meoreData){
		$('.subscribe').each(function(idx,obj) {
            for(v in resultData) {
                var data = resultData;
                var statusText = Math.random() < 0.5 ? '접수중' : '신청완료';
