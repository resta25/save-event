...
main .page-title {height: 100%; line-height: 1; padding: 0; padding-bottom: 4.3rem; border-bottom: 2px solid #c1e2e2; font-size: 6.2rem; text-align: center; background-color: #fff; font-weight: 400;}
main .page-title strong {color: #008d8f;}
.inner {padding: 8.8rem 4rem 16.3rem;}
...
#wrap{max-width: 1080px; width: 100%; letter-spacing: -1px; font-family: 'noto sans kr', sans-serif; display: flex; flex-direction: column; background: #fff;}
.form{flex-grow: 1;}
.page:not(#page-1){display:none;}
.pointColor{color: #005445;}


.icon_box {padding: 10.8rem 0 6.7rem;}
.icon_box .icon{width: 24.5%; margin:0 auto;transform: translateY(0%); animation: animate__floundering 1.5s cubic-bezier(.49, .16, .32, .86) infinite;}
...
/* add 설문 */
.question_box .question{font-size: 6.6rem; text-align: center; line-height: 1.2; ; margin: 0 auto 8rem;}
.question_box .question strong {font-size: 8.3rem;}


.question_box .q_select {display: grid; grid-template-columns: repeat(2, 1fr); column-gap: 4.7rem; row-gap: 4.3rem; padding: 0 2.2rem;}
.question_box .q_select label {}
.question_box .q_select label .sel-item {display: flex; align-items: center; justify-content: center; height: 30rem; line-height: 1.34; font-size: 5.2rem; text-align: center; font-family: 'Pretendard'; font-weight: 600; border-radius: 2.5rem; box-shadow: 0 0 20px 3px rgba(173, 218, 217, 0.8);}

/* db단 */

.form-group .item {margin-bottom: 1rem;}
.form-group .item input {padding: 3rem 2rem 4rem; font-size: 5rem; font-family: 'Gmarket Sans', sans-serif; line-height: 1; border: 3px solid #607a7a; border-radius: 2.7rem; letter-spacing: -0.05em;}
.form-group .item input::placeholder {color: #b6b6b6;}

#page-2 .question_box .question {margin-bottom: 5.3rem; font-size: 7.2rem; font-weight: 700; font-family: 'Noto Sans KR', sans-serif;}
#page-2 .question_box .question strong {display: block; width: 92%; margin: 3rem auto 2.5rem; padding: 2.3rem 0 2.5rem; text-align: center; line-height: 1; font-size: 5.4rem; letter-spacing: -0.05em; background-color: #00a0a2; color: #fff; font-family: 'Noto Sans KR', sans-serif;}
#page-2 .sub-text {display: block; margin-bottom: 5.3rem; text-align: center; font-size: 3.1rem; color: #a7a7a7; letter-spacing: -0.025em; font-family: 'Noto Sans KR', sans-serif;}
/* .form-group > .item {background: #d3d3d3; border-radius: 0.8rem; text-align: center;} */


/* cta 버튼 */
.form .submit {width: 90%; margin: 3.1rem auto 0; padding: 0;}
.form .submit input[type="image"]{width: 100%; padding: 0;}
...
.form input[type="checkbox"] + span:after,
.form input[type="radio"] + span:after {background-color:#000; /*#00bad2;*/ top:50%; left:6px; width:8px; height:8px; line-height:1.4px; margin-top:-4px; transform:scale(0); transform-origin:50%; transition.form 200ms ease-out;}
...
.form .agBox {margin-top: 2.7rem; text-align: center;}
.form .agBox label span {line-height: 1; margin: 0; padding-top: 0; padding-bottom: 0; font-size: 2.6rem; text-align: center;}
.form .agBox a {font-size: 2.2rem; font-weight: 600;}

.form .description {padding: 3% 0 0%; text-align: center;}
.form .description p,
...
@media screen and (max-width: 786px) {
    ...
    .inner {padding: 6.8rem 4rem 14.3rem;}
    main .page-title {font-size: 4.2rem;}
    .icon_box {padding: 8.8rem 0 4.7rem;}
    .question_box .question {margin-bottom: 6rem; font-size: 3.6rem;}
    .question_box .question strong {font-size: 5.3rem;}
    .question_box .q_select {column-gap: 3.7rem; row-gap: 3.3rem;}
    .question_box .q_select label .sel-item {height: 20rem; font-size: 3.8rem;}

    #page-2 .question_box .question {margin-bottom: 3.3rem; font-size: 4.2rem;}
    #page-2 .question_box .question strong {margin: 2rem auto 1.5rem; font-size: 3rem;}
    #page-2 .sub-text {margin-bottom: 4.3rem; font-size: 2.1rem;}
    .form-group .item input {padding: 2rem 2rem 3rem !important; font-size: 4rem;}
}
@media screen and (max-width: 480px){
    .inner {padding: 4.8rem 4rem 12.3rem;}
    main .page-title {font-size: 3.2rem;}
    .icon_box {padding: 6.8rem 0 2.7rem;}
    .question_box .question {margin-bottom: 5rem; font-size: 3.4rem;}
    .question_box .question strong {font-size: 4.8rem;}
    .question_box .q_select label .sel-item {height: 17rem; font-size: 3.8rem;}

    .form .description p, .form .description span, .form .description .ad_txt {font-size: 80%;}

    .container.footer {font-size: 1.4rem;}
}
...
<body id="page_landing_c" class="loaded">
    <main>
        ...
        <div id="wrap"> 
            <div class="inner">
                <h2 class="page-title">라미네이트 <strong>실시간 지원 센터</strong>입니다.</h2>
                <div class="form">
                    <form id="form-1" class="" method="POST" accept-charset="utf-8">
                    ...
                    <div class="formContents">
                        <section class="page" id="page-1">
                            <div class="question_box">
                                <div class="question">원하시는 항목을 선택하시면 <br /><strong>자세한 안내 도와 드립니다.</strong></div>
                                <div class="q_select">
                                    <label><input type="radio" name="tadd1" value="비용 문의"><div class="sel-item">비용 문의</div></label>
                                    <label><input type="radio" name="tadd1" value="치료 문의"><div class="sel-item">치료 문의</div></label>
                                    <label><input type="radio" name="tadd1" value="실시간 예약 문의"><div class="sel-item">실시간 <br />예약 문의</div></label>
                                    <label><input type="radio" name="tadd1" value="병원 위치 등 기타 문의"><div class="sel-item">병원 위치 등 <br />기타 문의</div></label>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="page" id="page-2">
                            <div class="question_box">
                                <div class="question">
                                    서비스 이용을 위한
                                    <strong>성함│나이│연락처│개인정보 처리방침</strong>
                                    동의 부탁드립니다.
                                </div>
                                <span class="sub-text">※귀하의 고중한 정보는 치료 상담 외에는 절대 사용하지 않습니다.</span>
                            </div>
