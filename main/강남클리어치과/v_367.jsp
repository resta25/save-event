...
<style>
    ...
    * {font-family: 'Gmarket Sans', 'Pretendard', sans-serif; box-sizing: border-box;}
    ...
    .page:not(#page-1) .paging {width: 65.937%; margin: 0 auto; text-align: center;}
    .paging {padding: 6%; border-radius: 0; background: url('//static.savemkt.com/event/v_${eventSeq}/btn_newsb.png') no-repeat center center / 100% 100%;}
    .paging button {background-color: transparent; margin: 0 auto;}
    ...
    #page-1 .video-wrap + .img-area .inner {position: absolute; left: 50%; bottom: 16%; display: flex; flex-direction: column; align-items: center; justify-content: center; width: 92.5%; height: 68.2%; transform: translateX(-50%); padding: 0 calc(100% - 87.071071%);}
    ...
    #page-1 .poster_01 > .img-area {width: 100%;}
    #page-1 .paging {width: 100%; margin: 5% auto; text-align: center;}
    ...
    #page_landing_c .inp::placeholder {color: #6d6d6d; font-weight: 400;}
    ...
    .db_btn, .submit input[type="image"] {animation: pulsating 0.8s linear infinite;
        -webkit-animation: pulsating 0.8s linear infinite; width: 70%; margin: 0 auto; cursor: pointer;}
    ...
    .notice-area {padding: 6px; background-color: #595959; text-align: center; font-weight: 200;}
    .notice-area > * {display: block; margin: 0; font-family: 'S-Core Dream'; font-size: 12px; color: rgba(255, 255, 255, 0.5); text-align: center;}
                ...
                <div class="formContents">
                    <section class="page" id="page-1">
                        ...
                        <div class="img-area">
                            ...
                            <div class="inner">
                                <div class="poster_01">
                                    <div class="img-area">
                                        <img src="//static.savemkt.com/event/v_${eventSeq}/intro_txt.png">
                                    </div>
                                    <p class="paging">
                    ...
                    <section class="page" id="page-2">
                        ...
                        <div class="inner">
                            ...
                            <p class="paging">
                                <button type="button" onclick="pageSelFuc(1, show3pg)" class="first"><img src="//static.savemkt.com/event/v_${eventSeq}/btn_newsb_txt_02.png"></button>
                            </p>
                        </div>
                    </section>
                    ...
                    <section class="page" id="page-3">
                        ...
                        <div class="inner">
                            ...
                            <div class="formGroup">
                                ...
                                <div class="submit"><input type="image" value="" onclick="fnForm('form-1')" class="btn_submit" src="//static.savemkt.com/event/v_${eventSeq}/btn_newsb_txt_03.png" /></div>
                            </div>
...
덴티움 임플란트(개당) 정상가: 45만원 → 이벤트 적용가: 24만원</p>
            </div>
...
<script>
    ...
    function startCountOnPage2Enter() {
        ...
        countTimer = setTimeout(decreaseCount, 1000); // ← 이 줄이 빠져서 시작이 안 됨
    }
