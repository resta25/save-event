...
<style>
    ...
    * {font-family: 'Gmarket Sans', 'Pretendard', sans-serif; box-sizing: border-box;}
    ...
    .video-wrap::before {content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.75);}
    ...
    #page-1 .inner {padding: 4% 1%; border-radius: 25px; box-sizing: border-box; width: 95%; margin: 0 auto; background-color: #fff;}
    ...
    table {border: 1px solid #000; border-collapse: collapse; width: 100%; table-layout: fixed;}
