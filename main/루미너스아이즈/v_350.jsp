...
<style>
    ...
    * {font-family: "Pretendard", sans-serif; box-sizing: border-box;}
    ...
    .top-fixed {z-index: 1; position: fixed; top: 0; left: 50%; transform: translateX(-50%); width: 100%; max-width: 1080px;}
    .top-fixed .count-box {position: absolute; bottom: 7%; left: 47.5%; width: 10.4rem; text-align: center; font-family: 'Pretendard'; font-weight: 700; font-size: 5.2rem; color: #fff600;}
    ...
    #page_landing_c .wrap_curd .q_select label {display: block; width: calc((100% - 4.8rem) / 3); padding: 2rem 0; text-align: center; font-size: 4.1rem; font-family: 'Pretendard'; color: #000; letter-spacing: -0.2px; font-weight: 500; background-color: #fff; border: 3px solid #ff004e; border-radius: 1rem;}
    #page_landing_c .wrap_curd .q_select label.active {background-color: #ff004e; color: #fff;}
...
@media screen and (max-width: 480px){
    ...
    .top-fixed .count-box {width: 6.4rem; font-size: 2.7rem;}
...
<body id="page_landing_c" class="loaded">
    <main>
        <div class="img-area top-fixed">
            <img src="//static.savemkt.com/event/v_${eventSeq}/event_main_01.gif">
            <span class="count-box">30명</span>
        </div>
                    ...
                    <div class="form_inner">
                        <div class="question_container">
                            <div class="question_container">
                                ...
                                <div class="q_select">
                                    <label><input type="checkbox" name="tadd1[]" value="안면홍조">안면홍조</label>
                                    <label><input type="checkbox" name="tadd1[]" value="불면증">불면증</label>
                                    <label><input type="checkbox" name="tadd1[]" value="우울증">우울증</label>
                                    <label><input type="checkbox" name="tadd1[]" value="뼈/근육통">뼈/근육통</label>
                                    <label><input type="checkbox" name="tadd1[]" value="두통">두통</label>
                                    <label><input type="checkbox" name="tadd1[]" value="두근거림">두근거림</label>
                                </div>
