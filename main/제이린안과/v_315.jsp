...
#wrap {width: 100%; max-width: 1080px; background-color: #fff;}
.page:not(#page-1) {width: 85%; margin: 0 auto; padding-top: 5%;}
...
#page-1 {padding-bottom: 7%;}
.poster_01 {padding-top: 7%;}
.poster_01 > .img-area {width: 67.45%; margin: 0 auto 7.97%;}

#page-1 .img-box {padding-top: 7%;}
#page-1 .img-box .img-area:nth-child(1) {width: 73.25%; margin: 0 auto;}
#page-1 .img-box .img-area:nth-child(2) {width: 59.352%; margin: -21% auto 0;}
...
.page .paging button {position: relative; width: 100%; height: 156px; background: url('//static.savemkt.com/event/v_${eventSeq}/btn_newsb.png') no-repeat center center / 100% 100%; margin: 0 auto; padding: 0% 0;}
.page .paging button img {width: 61.46% !important; margin: 0 auto; animation: pulsating 0.8s linear infinite;
    ...
    #page-1 .paging{margin-top: -24%; padding-top: 0%; padding-bottom: 0%;}
    ...
    .form .table_box input {background: #ededed; border-radius: 0.8rem; font-size: 2.8rem; border: none; background: transparent; width: 100%; padding: 1.5rem 0 1.5rem 2rem; font-family: 'GmarketSans'; font-weight: 500; text-align: center;}
    ...
    /* 개인정보 처리방침 */
    .agBox {padding-top: 5%; font-family: 'GmarketSans'; font-weight: 400; font-size: 1.4rem; line-height: 1; text-align: center; color: #fff;}
    ...
    [class^="popup-"] .btn-box button {
        ...
        font-family: 'GmarketSans'; */
        background: url("//static.savemkt.com/event/v_${eventSeq}/btn_popup_confirm.png") no-repeat center top / 100% 100%;;
    }
    [class^="popup-"] .btn-box button.btn-confirm {}
                ...
                <div class="formContents"> 
                    ...
                    <section class="page" id="page-1">
                        ...
                        <div class="img-box">
                            ...
                            <div class="img-area"><img src="//static.savemkt.com/event/v_${eventSeq}/arrow.png"></div>
                        </div>
                        ...
                        <p class="paging poster_02">
                            ...
                            <div class="agBox">
                                혜택 제공을 위한 <a href="javascript:void(0);" class="btn-agreement"><b>개인정보처리방침</b></a>에 동의해주세요
                            </div>
                        </p>
                    </section>
                    ...
                    <section class="page" id="page-3">
                        <div class="img-area poster_05"><img src="//static.savemkt.com/event/v_${eventSeq}/q_02.png"></div>
                        <div class="img-area poster_06"><img src="//static.savemkt.com/event/v_${eventSeq}/gage_02.png"></div>
                        <div class="question_box">
                            <div class="q_select">
                                <label><input type="radio" name="tadd2" value="예">예</label>
                                <label><input type="radio" onclick="setTimeout(show4pg, 100)" onclick="pageFuc(3,$(this))" name="tadd2" value="아니오">아니오</label>
                            </div>
                        </div>
                    ...
                    <!-- <section class="page" id="page-4">
                        ...
                        <div class="img-area poster_08"><img src="//static.savemkt.com/event/v_${eventSeq}/q_03.png"></div>
                        <div class="question_box">
                            <div class="q_select">
                    ...
                    <div class="popup-confirm">
                        <div class="img-area">
                            <img src="//static.savemkt.com/event/v_${eventSeq}/txt_popup_01.png">
                        </div>
                        <div class="btn-box">
                    ...
                    <div class="popup-confirm2">
                        <div class="img-area">
                            <img src="//static.savemkt.com/event/v_${eventSeq}/txt_popup_02.png">
                        </div>
                        <div class="btn-box">
                            <button type="button" class="btn-confirm"></button>
                            <button type="button" class="btn-out"></button>
...
<script>
    ...
    $('input[name="tadd2"]').on('change', function () {
        if ($(this).val() === "예") {
            $('.popup-confirm2 .img-area img').css({'width': '69.045%', 'margin': '0 auto'});
    ...
    $('.popup-confirm2 .btn-confirm').on('click', function () {
    ...
    $('.popup-confirm2 .btn-out').on('click', function(){
        $('.overlay, .popup-confirm2').hide();
    ...
    function show3pg() {
        ...
        animation03.from('#page-3 .next_btn_inQuestion', {x: +200, opacity: 0, duration: 0.2});
    }
