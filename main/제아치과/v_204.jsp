...
.page:not(#page-1) {width: 100%; margin: 0 auto;}
/* .page:not(#page-1) .img-area {margin-bottom: 3%;} */

.page .bg {background: url('//static.savemkt.com/event/v_${eventSeq}/bg.png') no-repeat center top / 100% 100%; margin: 3%; padding: 3%;}
.page .bg > .img-area:nth-child(1) {margin-bottom: 3%;}
...
.count_box {width: 15%; text-align: center; font-size: 2.8rem; color: #fff; position: absolute; top: 21.5%; left: 54.5%; transform: translateX(-50%);}
.count {color: #00e4ff; font-size: 4.5rem; font-family: 'GmarketSans'; font-weight: 600;}
...
.poster_01 {margin: 12.67% 0; padding-top: 35.56%; padding-bottom: 5%; background: url('//static.savemkt.com/event/v_${eventSeq}/intro.png') no-repeat center center / 100% 100%;}
.poster_01::before {content: ''; position: absolute; top: -19%; width: 100%; height: 39px; background-color: #075fa5;}
.poster_01::after {content: ''; position: absolute; bottom: -19%; width: 100%; height: 39px; background-color: #075fa5;}
...
.page .paging button img {width: 61.46% !important; margin: 0 auto; animation: pulsating 0.8s linear infinite;
    ...
    #page-2 .paging{padding-top: 0%;}
   
    #page-2.page .paging button img {width: 21.46% !important;}
                        ...
                        <section class="page" id="page-2">
                            <div class="container">
                                <div class="img-area roulette">
                                    ...
                                    <div class="count_box"><em class="count"></em></div>
                                </div>
                                <!-- 시침 -->
                            ...
                            <div class="bg">
                                ...
                                <div class="question_box">
                                    <div class="q_select">
                                        <label><input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="1~2개">1~2개</label>
                                        <label><input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="3~4개">3~4개</label>
                                        <label><input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="5개 이상">5개 이상</label>
                                    </div>
                                </div>
                                <p class="paging">
