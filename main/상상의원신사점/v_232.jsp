            ...
            <div class="wrap_form">
                <form class="wrap_curd" id="form-1" method="POST" accept-charset="utf-8">
                    <ul class="layout_add01 question">
                        <li>엉덩이 고민 중 해당되는 항목을 선택해주세요</li>
                    </ul>
                    <ul class="layout_add02">
                        <li>
                            <label><input type="radio" name="tadd1" value="사이즈" class="answer">사이즈</label>
                            <label><input type="radio" name="tadd1" value="탄력" class="answer">탄력</label>
                            <label><input type="radio" name="tadd1" value="힙업" class="answer">힙업</label>
                            <label><input type="radio" name="tadd1" value="엉덩이 라인" class="answer">엉덩이 라인</label>
                        </li>
                    </ul> 
                    <p id="event-period"></p>
                    <table>
