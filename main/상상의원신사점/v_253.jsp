...
pageEncoding="UTF-8"%>
<style>
    #page_landing_c main {background-color: #fff !important; max-width: 1080px !important; margin: 0 auto;}
    html{
        height: 100%;
    }
...
<body id="page_landing_c" class="loaded">
    <main>
            ...
            <div class="wrap_form">
                <form class="wrap_curd" id="form-1" method="POST" accept-charset="utf-8">
                    <ul class="layout_add01 question">
                        <li>해당되는 고민사항을 선택해주세요</li>
                    </ul>
                    <ul class="layout_add02">
                        <li>
                            <label><input type="radio" name="tadd1" value="상복부" class="answer">상복부</label>
                            <label><input type="radio" name="tadd1" value="하복부" class="answer">하복부</label>
                            <label><input type="radio" name="tadd1" value="러브핸들" class="answer">러브핸들</label>
        ...
        <div class="img-area">
            <img src="//static.savemkt.com/event/v_${eventSeq}/notice_footer.jpg">
        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        sangsangSinsaAgreement(); //개인정보처리방침 전문
    });
