...
<style>
    ...
    * {font-family: "Noto Sans KR", sans-serif; box-sizing: border-box;}
    ...
    #page_landing_c main {max-width: 1080px; background-color: #6bd0ff;}
    ...
    .overlay {z-index: 998; position: fixed; top: 0; left: 0; display: none; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.7);}
    .popup-coupon {z-index: 999; position: absolute; top: 0%; left: 50%; transform: translate(-50%, 50%); max-width: 970px; width: 100%; margin: 0 auto; display: none;}
    ...
    #page_landing_c .form .form_bg_box {padding: 4rem 3.7rem; background-color: #fff; border-radius: 36px;}
        ...
        <div id="wrap">
            ...
            <div class="wrap_form form">
                <form class="wrap_curd" id="form-1" method="POST" accept-charset="utf-8">
                    <div class="container">
                        <div class="img-area" style="padding: 2rem;"><img src="//static.savemkt.com/event/v_${eventSeq}/event_main_02.png"></div>
                            <!-- <div class="count-box">
