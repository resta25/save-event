...
.form .question_box .q_select label{width:100%; padding: 4% 0 3.5%; border: 1px solid #092b7b; cursor:pointer; background: #fff;  border-radius: 2rem; font-size: 200%; font-weight: 500; font-family: 'Pretendard';}
...
.form .table_box .legend {font-size: 182%; font-weight: 800; letter-spacing: -0.075em; font-family: 'Pretendard';}
