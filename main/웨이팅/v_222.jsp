...
#wrap{background:#ffffff; max-width: 600px; width: 100%;}
.form, .form .formContents{background-color:#ffffff;}
.page:not(#page-1) {width: 100%; margin: 0 auto; padding: 5.398% 7.5%; background-color: #fff;}
...
.page .paging button {position: relative; width: 100%; height: 114px; background: url('//static.savemkt.com/event/v_${eventSeq}/btn_newsb_01.png') no-repeat center center / 100% 100%; margin: 0 auto; padding: 0% 0;}
...
#page-1 .paging{width: 69.26%; padding: 2.705% 0 7.93%;}
#page-1 .poster_02 {position: relative; background: url('//static.savemkt.com/event/v_${eventSeq}/event_main_02.png') no-repeat top center / 100% 100%; margin: 24.167% 3.75% 7.335%; padding-top: 5.835%;}
#page-1 .poster_02 > .img-area {width: 56.397%; margin: 0 auto; padding-bottom: 9.55%;}
...
/* 이름, 전화번호 boz */
.formGroup {background: url("//static.savemkt.com/event/v_${eventSeq}/event_main_03.png") no-repeat top center / 100% 100%; padding: 14.285% 6.746%;}
...
/* 개인정보 처리방침 */
.agBox {display: flex; align-items: center; justify-content: center; column-gap: 0.5rem; font-family: 'Pretendard'; font-weight: 500; font-size: 1.4rem; line-height: 1;}
...
@media screen and (max-width: 500px){
    ...
    .form .table_box .legend, .form .question_box .legend {font-size: 152%;}
}
                    ...
                    <div class="formContents"> 
                        ...
                        <section class="page" id="page-2">
                            <div class="img-area poster_03">
                                <div class="count-area">
                                    <div class="count-box img-area">
                                        <img src="//static.savemkt.com/event/v_${eventSeq}/count_02.png">
                            ...
                            <div class="form-box poster_11">
                                <div class="formGroup">
                                    <div class="question_box">
                                        <span class="legend">상품 선택</span>
                                        <div class="q_select">
                                            <label><input type="radio" name="tadd1" value="인터넷 + TV">인터넷 + TV</label>
                                            <label><input type="radio" name="tadd1" value="인터넷 + TV + 핸드폰">인터넷 + TV + 핸드폰</label>
                                        </div>
                                    </div>
                                    <div class="question_box">
                                        <span class="legend">통신사</span>
                                        <div class="q_select">
                                            <label><input type="radio" name="tadd2" value="SKT">SKT</label>
                                            <label><input type="radio" name="tadd2" value="KT">KT</label>
                                            <label><input type="radio" name="tadd2" value="LG U+">LG U+</label>
                                        </div>
                                    </div>
