...
#wrap{max-width:600px; overflow: hidden; height:100vh; background:#eaeaea;}
.form, .form .formContents{background-color:#eaeaea;}
.page:not(#page-1) {padding: 3% 10%;}
.page .img-area {margin-bottom: 5%;}
#page-4 {padding: 0 10% !important;}

/* 룰렛 영역 */
.roulette {padding: 3% 5%;}
.roulette image {width: 100%;}
.count_box {width: max-content; text-align: center; font-size: 150%; color: #fff; position: absolute; top: 50%; left: 25%; transform: translateY(-50%);}
.count {color: #fff799;}
...
.page .paging{padding:15% 10% 10%; margin: 0 auto; display: flex;    justify-content: space-between;}
...
.form .formContents .description{text-align:center;box-sizing:border-box;}
...
.form .question_box .q_select label{width:100%;padding-bottom:3%;cursor:pointer;}
...
.form .table_box input {background: #fff; border-radius: 15px; font-size: 90%; padding: 3%; text-align: center; border: 1px solid #75797a; text-align: left;}
.form .table_box input::placeholder{font-size: 120%; text-align: center; color: #323232; text-align: left;}
...
/* submit btn */
.form .submit {width: 85%; margin: 0 auto; padding: 1% 0;}
...
@media screen and (max-width: 480px){
    ...
    .form .table_box input {font-size: 110%;}
}
...
<div id="wrap"> 
	<div class="container">
        <div class="img-area roulette"><img src="//static.resta.co.kr/event/v_${eventSeq}/popup_01.png"></div>
		...
		<div class="formContents"> 
            ...
            <section class="page" id="page-1">
                <div class="poster_01">
                    ...
                    <a href="javascript:void(0);" class="btn-agreement">혜택 제공을 위한 개인정보처리방침에 동의해 주세요</a>
                </div>

                <p class="paging poster_02">
                    <label onclick="show2pg()" class="first"><input type="checkbox" name="agBox"><img src="//static.resta.co.kr/event/v_${eventSeq}/btn_newSb_01.png"></label>
                </p>
			</section>
			...
			<section class="page" id="page-2">
                ...
                <div class="question_box">
					<div class="q_select">
						<label><input type="radio" onclick="setTimeout(show3pg, 100)" name="tadd1" value="이마"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off_01.png"></label>
						<label><input type="radio" onclick="setTimeout(show3pg, 100)" name="tadd1" value="정수리"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off_02.png"></label>
						<label><input type="radio" onclick="setTimeout(show3pg, 100)" name="tadd1" value="여러 부위"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off_03.png"></label>
						<label><input type="radio" onclick="setTimeout(show3pg, 100)" name="tadd1" value="기타"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off_04.png"></label>
					</div>
				</div>              
			</section>
			...
			<section class="page" id="page-3">
                ...
                <div class="img-area poster_06"><img src="//static.resta.co.kr/event/v_${eventSeq}/q_03.png"></div>
                    <div class="question_box">
                        <div class="q_select">
                            <label><input type="radio" onclick="setTimeout(show4pg, 100)" name="tadd2" value="30대"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off_09.png"></label>
                            <label><input type="radio" onclick="setTimeout(show4pg, 100)" name="tadd2" value="40대"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off_10.png"></label>
                            <label><input type="radio" onclick="setTimeout(show4pg, 100)" name="tadd2" value="50대"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off_11.png"></label>
                            <label><input type="radio" onclick="setTimeout(show4pg, 100)" name="tadd2" value="60대 이상"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off_12.png"></label>
                        </div>
                    </div>              
			</section>

			<section class="page" id="page-4">
                <div class="img-area poster_07"><img src="//static.resta.co.kr/event/v_${eventSeq}/gage_06.png"></div>
                <div class="poster_08">
                    <div class="img-area" style="margin: 0 -13%;"><img src="//static.resta.co.kr/event/v_${eventSeq}/event_main_03.png"></div>
                </div>
...
<script>
    ...
    function show2pg() {
        ...
        animation02.to('#page-1 .poster_01', { x: -100, opacity: 0, delay: 0.2, duration: 0.3, ease: "power1.out"}, 0);
        animation02.to('#page-1 .poster_02', { x: -100, opacity: 0, delay: 0.6, duration: 0.3, ease: "power1.out"}, 0);
        animation02.to('#page-1', { display: 'none' });
        animation02.to('#page-2', { display: 'block', duration: 0.1 });
        animation02.from('#page-2 .poster_03', {x: +200, opacity: 0, duration: 0.3});
        animation02.from('#page-2 .poster_04', {x: +200, opacity: 0, duration: 0.3});
        animation02.from('#page-2 .question_box .q_select > label', {x: +200, opacity: 0, duration: 0.3, stagger: 0.1});
    }
    // 세번째 페이지
    function show3pg() {
        if (isAnimating) return; // 이미 애니메이션 중이면 실행 안 함
        ...
        animation03.to('#page-2 .poster_03', { x: -100, opacity: 0, delay: 0.2, duration: 0.3, ease: "power1.out"}, 0);
        animation03.to('#page-2 .poster_04', { x: -100, opacity: 0, delay: 0.4, duration: 0.3, ease: "power1.out"}, 0);
        animation03.to('#page-2 .question_box .q_select > label', {x: -100, opacity: 0, stagger: 0.1});
        animation03.to('#page-2', { display: 'none' });
        animation03.to('#page-3', { display: 'block', duration: 0.1 });
        animation03.from('#page-3 .poster_05', {x: +200, opacity: 0, duration: 0.3});
        animation03.from('#page-3 .poster_06', {x: +200, opacity: 0, duration: 0.3});
        animation03.from('#page-3 .question_box .q_select > label', {x: +200, opacity: 0, duration: 0.3, stagger: 0.1});
    }
    ...
    function show4pg() {
        ...
        animation04.to('#page-3 .poster_05', { x: -100, opacity: 0, delay: 0.2, duration: 0.3, ease: "power1.out"}, 0);
        animation04.to('#page-3 .poster_06', { x: -100, opacity: 0, delay: 0.4, duration: 0.3, stagger: 0.1, ease: "power1.out"}, 0);
        animation04.to('#page-3 .question_box .q_select > label', {x: -100, opacity: 0, stagger: 0.1});
        animation04.to('#page-3', { display: 'none', duration: 0.1 });
        animation04.to('#page-4', { display: 'block', duration: 0.1 });
        animation04.from('#page-4 .poster_07', {y: +100, opacity: 0, duration: 0.3});
        animation04.from('#page-4 .poster_08', {y: +100, opacity: 0, duration: 0.3});
        animation04.from('#page-4 .formGroup', {y: +100, opacity: 0, duration: 0.3});
        animation04.from('#page-4 .description', {y: +100, opacity: 0, duration: 0.3});
    }
