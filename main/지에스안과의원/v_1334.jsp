<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<style>
#wrap {padding-bottom: 10%; font-family: 'noto sans kr'; background: #fff;} 
/* 고정버튼 */
.fixed {position: fixed; z-index: 9; bottom: 0%; cursor: pointer;}

/* 타이머 */
#timer {display: block; position: absolute; top: 46%; transform: translateY(-50%); letter-spacing: -0.1rem; right: 18%; color: #562dd8; font-weight: 700; font-size: 210%;}

/* 하단 form-inner */
.form_inner {background: #fff; padding: 10%; padding-bottom: 0;}

/* 이름, 나이, 연락처 입력칸 */
.formGroup {}
.formGroup .user_info {display: flex; flex-flow: column; margin-bottom: 3%;}
.legend {padding: 1%; font-weight: 700; font-size: 110%;}
.legend::after {display: inline-block; content: '*'; color: #fb8500; position: relative; top: -2px; left: 2px;}
.formGroup .user_info input {padding: 2%; font-size: 120%; background: #f8f9fc; border: 1px solid #c5c5c5; border-radius: 0.5rem;}

.question_box {display: flex; flex-flow: column; }
.question_box .q_select {background: #f8f9fc;  border: 1px solid #c5c5c5; font-size: 120%; padding: 2%; padding-right: 0; border-radius: 0.5rem;}
/* 개인정보처리방침 영역 */
.form .agBox {margin: 3% auto;}

/* 이벤트기간, 안심문구, 대상 영역 */
.form .description { margin: 5%;}
.form .description p,
.form .description .ad_txt,
.form .description span {font-size: 80%; font-weight: 500;}
.form .description .call_num {color: #ccc;}

/* 개인정보 처리방침 */

/* 실시간 신청 현황 */
.subscribe_container {position: relative;}
.subscribe_container img {width: 100%;}
/* .subscribe_container .img-area {width: 40%; margin: 3% auto;} */
.subscribe {max-height: 210px; overflow: hidden; border-radius: 0.8em; position: absolute; top: 35%; left: 50%; transform: translateX(-50%); width: 84%; border-radius: 0; padding: 0;}
.subscribe .content {padding: 0.6rem 2rem; display: flex; align-items: center; font-size: 100%; margin: 1% 0; justify-content: space-between; border-bottom: 1px solid #ddd !important;}
.subscribe .content > div {width: calc(100% / 4); padding: 0.2rem 0; font-weight: 700;}
...
.subscribe .content .text { text-align: center; width: 18%;}
.color-bg {
        background-color: #562dd8;
        font-weight: 700;
        border-radius: 1em;
        color: #fff;
    }
...
@media screen and (max-width: 500px){
    ...
    #timer {font-size: 130%; right: 20%;}
    .subscribe {max-height: 125px;}
    .subscribe .content {padding: 0.3rem 2rem;}
...
@media screen and (max-width: 360px){
    .subscribe {max-height: 90px;}
    .subscribe .content {padding: 0.3rem 1rem;}
...
<div id="wrap"> 
    <div class="img-container">
        <div class="img-area">
            <img src="//static.resta.co.kr/event/v_${eventSeq}/event_main_00.jpg">
            <span id="timer"></span>
        </div>
    ...
    <div class="subscribe_container">
        <img src="//static.resta.co.kr/event/v_${eventSeq}/event_main_05.jpg">
        ...
        <div class="form_inner">
            ...
            <div class="question_box">
                ...
                <select class="q_select" name="tadd1" required>
                    ...
                    <option value="스마일프로">스마일프로</option>
            ...
            <div class="description">
				...
				<p class="call_num">문의처 : gseyeweb@naver.com</p>
            </div>
        </div>
        <!-- common input start-->
