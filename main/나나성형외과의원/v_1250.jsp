...
.form .description.orage-box * {color:#000; font-size: 100%; font-weight: 700;}
.form .description.orage-box p {position: absolute; top: 2%; left: 7%;}
.form .description.orage-box span {position: absolute; top: 2%; right: 17%;}

.form .question {position: relative;}
.question_container_bg {position: absolute; top: 60%; left: 50%; transform: translateX(-50%); width: 100%;}
.question_container {position: relative;}
.form .question_box {position: absolute; top: 7%; left: 50%; transform: translateX(-50%); width: 90%;}
...
label.selected_label{width: 125px; height: 62px; border-radius:10px; margin-right:1%; margin-bottom:2%; text-align: center; line-height: 62px; color: #c86964; cursor: pointer;}

.form .question_box .q_select:nth-of-type(2) label{background-color: #ffa49f; color: #c86964;}
.form .question_box .q_select:nth-of-type(2) label.on,
label.add1{background-color: #8a1a32; color:#fff9fc;}
...
.form .question_box .q_select label{background-color: #ffa49f ;}
...
.form .agBox label, .form .agBox .disagree{font-size:100%; border-radius:10px; color:#c86964; display:inline-block; width: 120px; height: 62px; margin-bottom: 2%; margin-right: 1%; line-height: 62px; text-align: center; cursor: pointer; margin-left: 2%;}
.form .agBox label{background-color: #127ee3;}
.form .agBox .disagree{background-color: #ffa49f ; font-weight: normal;}

.form .agBox.on label{background-color:#8a1a32; color: #fff9fc;}
...
.form .result .value {display: flex; position: absolute; left: 6.8%; bottom: 5.5%; width: 100%;}
.form .result .value .add_value {font-size: 120%; background-color: #8a1a32; width: 77px; height: 44px; border-radius: 10px;
text-align: center; line-height: 44px; color: #fff9fc; cursor: pointer; display: none;}
.form .result .value .add1_value {margin-right: 0.5%;}
.form .result .value .add2_value {}

.question .q_select.last label {width: 150px;}

.notice {font-size: 100%; text-align: center; color: #ddd;}
.notice p {margin: 0;}
...
@media screen and (max-width: 500px){
	...
	.form .description.orage-box p {left: 3%; top: 1.8%;}
	.form .description.orage-box span {right: 18%; top: 1.8%;}
	...
	#name {font-size: 120%;}
	.form .result .value {left:7.5%; top: 12%;}
			...
			<div class="question_container">
				<div class="question_box">
					...
					<div class="formGroup">
						<div class="user_info">
							<div class="user_name">
								...
								<input type="text" id="name" name="name" value="" class="inp" required autocomplete="off">
							</div>
							<div class="user_phone">
								<img src="//static.resta.co.kr/event/v_${eventSeq}/q_04.png">
								<input type="tel" id="phone" name="phone" value="" class="inp" required autocomplete="off" maxlength="11">
							</div>
						</div>
					</div>
					...
					<div class="formContents">	
						...
						<div class="submit"><input type="image" value="" onclick="fnForm('form-1')" class="btn_submit" src="//static.resta.co.kr/event/v_${eventSeq}/btn_newSb.png" /></div>
						<div class="notice">
							<p>* 명시된 수술 외 다른 수술은 수가가 달라질 수 있습니다.</p>
							<p>* 수술 후 출혈,감염,신경 손상 등의 부작용이 발생할 수 있습니다.</p>
						</div>
					</div>
				</div>   
			</div>
...
<script>
	...
	$('.table_box label').on('click',function() {
		if($(this).hasClass('db-name')){		
			...
			// $(this).find('img').attr('src','//static.resta.co.kr/event/v_${eventSeq}/phone_08.png');
