<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="javax.servlet.http.*, java.util.regex.*" %>
<style>
...
%>
	...
	<iframe src="https://smartstore.naver.com/bosunghcare/products/10824004565" style="width:100%; height:100vh; border:0 none; overflow:hidden; padding:0; margin:0;"></iframe>
<%
		out.flush();
		return;
	}
