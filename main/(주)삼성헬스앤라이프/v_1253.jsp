...
/* 타이머 */
#timer {position: absolute; top: 50%; transform: translateY(-50%); right: 29%; color: #ffef7d; font-size: 200%;}
        ...
        <div class="form_inner">
            ...
            <div class="question_box">
                ...
                <select class="q_select" name="tadd1" required>
                    ...
                    <option name="" value="혈당">혈당</option>
                    <option name="" value="혈압">혈압</option>
                    <option name="" value="눈 건강">눈 건강</option>
                </select>
            </div>
