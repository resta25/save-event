...
/* 타이머 */
#timer {position: absolute; top: 46%; transform: translateY(-50%); right: 29%; color: #ffef7d; font-size: 200%;}
...
<div id="wrap"> 
    <div class="img-container">
        ...
        <div class="img-area"><img src="//static.resta.co.kr/event/v_${eventSeq}/event_main_03.gif"></div>
        ...
        <div class="form_inner">
            ...
            <div class="question_box">
                ...
                <select class="q_select" name="tadd1" required>
                    ...
                    <option name="" value="변비">변비</option>
                    <option name="" value="소화불량">소화불량</option>
                    <option name="" value="위장장애">위장장애</option>
                </select>
            </div>
