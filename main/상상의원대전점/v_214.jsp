...
#page-1 {}
.poster_01 > .img-area {width: 100%;}
.poster_02 {position: relative; padding-top: 3%; background-color: #fff;}
...
.page .paging button,
.form .next_btn_inQuestion {position: relative; width: 100%; height: 186px; background: url('//static.savemkt.com/event/v_${eventSeq}/btn_newsb.png') no-repeat center center / 100% 100%; margin: 0 auto; padding: 0% 0;}
...
.page .paging button a {display:block;}
    ...
    .form .description p, .form .description .ad_txt, .form .description span {font-family: 'GmarketSans'; font-weight: 300; font-size: 125%;}
    ...
    .form .question_box .q_select label{width:100%;padding: 1% 0; cursor: pointer; background: #e2e2e2; border-radius: 1.8rem; font-size: 238%; font-weight: 600; font-family: 'GmarketSans';}
    ...
    .form .next_btn_inQuestion {display: flex; align-items: center; width: 70%; margin: 5% auto; cursor: pointer;}
    .form .next_btn_inQuestion img {width: 61.46% !important; margin-right: 0px; margin-left: auto; animation: pulsating 0.8s linear infinite;
-webkit-animation: pulsating 0.8s linear infinite;}
    ...
    .form .table_box input {background: #e2e2e2; border-radius: 1.8rem; font-size: 2.8rem; border: none; background: transparent; width: 100%; padding: 1.5rem 0 1.5rem 2rem; font-family: 'GmarketSans'; font-weight: 500; text-align: left;}
    ...
    /* 개인정보 처리방침 */
    .agBox {text-align: center; font-family: 'GmarketSans'; font-weight: 500; font-size: 1.4rem; line-height: 1; color: #000;}
...
-webkit-animation: pulsating 0.8s linear infinite;}
    ...
    @media screen and (max-width: 786px) {
        ...
        .form .next_btn_inQuestion {height: 56px;}
            ...
            <div class="form">
                ...
                <div class="formContents"> 
                    ...
                    <section class="page" id="page-1">
                        ...
                        <div class="poster_02">
                            <div class="agBox">
                                <a href="javascript:void(0);" class="btn-agreement"><b>개인정보처리방침</b></a> 동의 후 <br />
                                안빠지는 부위에 특화된 지방배출 받으세요
                            </div>
                            <p class="paging">
                    ...
                    <section class="page" id="page-2">
                        <div class="inner">
                            ...
                            <div class="question_box">
                                <div class="q_select">
                                    <label><input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="뱃살">뱃살</label>
                                    <label><input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="팔뚝살">팔뚝살</label>
                                    <label><input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="허벅지살">허벅지살</label>
                                    <label><input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="기타">기타</label>
                                </div>
                            </div>
                            <div class="next_btn_inQuestion"><img src="//static.savemkt.com/event/v_${eventSeq}/btn_newsb_txt_02.png" onclick="pageSelFuc(4,$(this))"></div>
                        </div>
                        ...
                        <div class="inner">
                            ...
                            <div class="form-box poster_11">
                                <div class="formGroup">
                                    ...
                                    <div class="submit"><input type="image" value="" class="btn_submit" src="//static.savemkt.com/event/v_${eventSeq}/btn_newsb_03.png" /></div>
                                </div>
