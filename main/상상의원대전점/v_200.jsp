...
.page .paging button img {width: 61.46% !important; margin: 0 auto; animation: pulsating 0.8s linear infinite;
    ...
    .form .description p, .form .description .ad_txt, .form .description span {font-family: 'GmarketSans'; font-weight: 400; font-size: 125%;}
    ...
    .form .table_box input {background: #e2e2e2; border-radius: 1.8rem; font-size: 2.8rem; border: none; background: transparent; width: 100%; padding: 1.5rem 0 1.5rem 2rem; font-family: 'GmarketSans'; font-weight: 600; text-align: left;}
