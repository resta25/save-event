...
<style>
    ...
    * {font-family: "Noto Sans KR", sans-serif; box-sizing: border-box;}
    ...
    .wrap_form .agBox {width: 100%; margin: 7px auto; font-size: 200% !important;}

    #page_landing_c main {max-width: 1080px;}
    #page_landing_c .wrap_form {padding: 0; border: 0; width: 100%; background: url("//static.savemkt.com/event/v_${eventSeq}/bg_01.png") no-repeat; background-size: 100%;}
    ...
    #page_landing_c .wrap_form .submit {position: relative; width: 100%; max-width: 704px; height: 144px;}
    ...
    #page_landing_c .wrap_form .submit input {height: auto !important; cursor: pointer;}
    ...
    /* form css */
    #page_landing_c .form {overflow: hidden; display: none; padding-top: 5%; padding-bottom: 12%;}
    ...
    #page_landing_c .form .form_box {width: 87%; margin: 5em auto 2em; display: grid; gap: 1.22em;}
    #page_landing_c .form .form_box .user-info {display: flex; align-items: center; column-gap: 0.5rem;}
    #page_landing_c .form .legend {width: 25%; text-align: right; display: inline-block; color: #030303; font-size: 4rem; line-height: 1; font-weight: 700; flex-shrink: 0; font-family: 'GmarketSans'; margin-top: 2%;}
    #page_landing_c .form .form_box .user-info input, #page_landing_c .form .form_box .user-info select {background: #fff; height: auto; border: solid 1px #757575; padding: 1.5rem; padding-right: 0; font-size: 3rem; border-radius: 0;}
    #page_landing_c .form .form_box .user-info select {appearance: none; background: #fff url('//static.savemkt.com/event/v_172/arrow_down.png') no-repeat center right 20px / 38px;}
    ...
    #page_landing_c .form .description p {font-weight: 700; font-family: 'GmarketSans'; margin-bottom: 2%; font-size: 230%; letter-spacing: -0.05em;}
    ...
    .wrap_form input[type="checkbox"] + span:before {border-color: #000;}
...
@media screen and (max-width: 768px){
    ...
    #page_landing_c .form .legend {font-size: 4.1vw; width: 27%;}
    #page_landing_c .form .form_box .user-info {column-gap: 0.2rem;}
    #page_landing_c .form .form_box .user-info input, #page_landing_c .form .form_box .user-info select {padding: 0.7rem 1rem; font-size: 1rem;}
    #page_landing_c .form .form_box .user-info select {background-position: center right 10px; background-size: 27px;}
    ...
    #page_landing_c .wrap_form .submit {height: 84px;}

    .wrap_form .agBox {font-size: 110% !important;}
}
@media screen and (max-width: 500px){
    ...
    #page_landing_c .form {padding-bottom: 5%;}
    ...
    .wrap_form .wrap_radio span {font-size: 100% !important; line-height: 1.5 !important;}
    .wrap_form .wrap_radio input[type="checkbox"] + span:after, .wrap_form .wrap_radio input[type="radio"] + span:after {
    ...
    .wrap_form .agBox {font-size: 90% !important;}
}
                    ...
                    <div class="formContents">
                        ...
                        <div class="form_bg_box">
                            <div class="description">
                                <p id="event-period"></p>
                                <div class="ad_txt">안녕하세요! 본원에서는 고객님의 소중한 개인정보를 <br />상담 외 어떠한 목적으로도 사용하지 않습니다.  </div>
