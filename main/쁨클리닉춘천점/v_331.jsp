...
<style>
    ...
    * {font-family: "Noto Sans KR", sans-serif; box-sizing: border-box;}
    ...
    .spinmachine_container {position: relative; padding: 7.95% 0 9.77%;}
    ...
    #page_landing_c .form .form_bg_box {padding: 4rem 3.7rem 0; background-color: #f0e9ff; border-radius: 36px;}
