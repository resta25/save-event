...
<style>
    ...
    * {font-family: "Noto Sans KR", sans-serif; box-sizing: border-box;}
    ...
    #page_landing_c main {max-width: 1080px; background-color: #c7e1bf;}
    ...
    #page_landing_c .wrap_form .container .img-area {width: 75%; margin: 0 auto;}
    ...
    .spinmachine_container {position: relative; padding: 16.77% 0 0;}
    ...
    .spinmachine_container #spinmachine {position: relative; bottom: 0; padding: 5.5% 0 10%; width: 100%; text-align: center; overflow: hidden;}
...
@media screen and (max-width: 500px){
    ...
    .spinmachine_container #spin-pin {top: 2.5%; max-width: 30px;}
}
