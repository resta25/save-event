...
/* 비디오 영역 */
.form .video-area {position: relative; padding-top: 65.27%; border: 8px solid #fff; border-right: 0; border-left: 0;}
...
.page .paging button img {width: 61.46% !important; margin: 0 auto; animation: pulsating 0.8s linear infinite;
    ...
    #page-1 .paging{padding-top:5%; padding-bottom: 5%;}
                ...
                <div class="formContents"> 
                    ...
                    <section class="page" id="page-2">
                        ...
                        <div class="question_box">
                            <div class="q_select">
                                <label><input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="기미">기미</label>
                                <label><input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="잡티">잡티</label>
                                <label><input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="색소침착">색소침착</label>
