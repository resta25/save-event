...
#wrap{}
.page:not(#page-1) {width: 92.777%; margin: 0 auto; padding-top: 1.39%;}
.page:not(#page-1) .img-area {margin-bottom: 3%;}
.logo-area {width: 13.973%; margin: 0;}
.logo-area + .img-area {width: 83.335%; margin: 3% auto;}
...
/* 비디오 영역 */
.form .video-area {position: relative; padding-top: 69.27%; border: 8px solid #fff; border-right: 0; border-left: 0;}
...
/* .poster_01 > .img-area {width: 79.537037%; margin: 0 auto 7.97%;} */
...
.page .paging button {position: relative; width: 100%; height: 186px; background: url('//static.savemkt.com/event/v_${eventSeq}/btn_newsb_02.png') no-repeat center center / 100% 100%; margin: 0 auto; padding: 0% 0;}
.page .paging button img {width: 71.46% !important; margin: 0 auto; animation: pulsating 0.8s linear infinite;
    ...
    #page-1 .intro-area {position: relative;}
    #page-1 .intro-area .content-box {position: absolute; bottom: 3%; width: 49.4%;}
    #page-1 .intro-area .content-box .paging {padding: 1% 3% 0%;}
    #page-1 .intro-area .content-box .paging button {height: 110px; background-image: url('//static.savemkt.com/event/v_${eventSeq}/btn_newsb_01.png')}
    #page-1 .intro-area .paging button img {width: 80% !important;}
    #page-1 .paging {padding-top: 4%; padding-bottom: 5%;}
    #page-1 .txt-area {padding-top: 5%; width: 56.112%; margin: 0 auto;}
    #page-1 .intro-area .agBox, #page-1 .intro-area .btn-agreement {font-size: 1rem;}

    #page-2 {background-color: #fff;}
    #page-2 .poster_04 {width: 49.502%; margin: 4% auto 0;}
    
    .form-box {margin-top: 10%;}
    .form .formContents  {background-color: #fff;}
    ...
    .form .question_box {text-align: center; padding: 4% 4% 5%; margin-bottom: 0%;}
    .form .question_box .q_select {display: flex; flex-direction: column; font-size: 150%;}
    .form .question_box .q_select label {width:100%; padding: 0; cursor:pointer; border-radius: 0.8rem; font-size: 200%; font-weight: 500; font-family: 'GmarketSans';}
    ...
    /* 이름, 전화번호 boz */
    .formGroup {}
    .form .table_box{ padding:0;background:#fff;border-radius:27px; margin-bottom: 18px; text-align: center;}
    .form .table_box input {border: 1px solid rgba(0, 0, 0, 0.55);
    ...
    /* 개인정보 처리방침 */
    .agBox {padding-top: 4%; font-family: 'GmarketSans'; font-weight: 400; font-size: 1.4rem; line-height: 1; text-align: center; color: #000;}
    .btn-agreement {flex-shrink: 0; text-align: center; font-size: 1.4rem; color: #000; font-family: 'GmarketSans';}
    ...
    .form .submit {position: relative; width: 90.155%; height: 154px; background: url('//static.savemkt.com/event/v_${eventSeq}/btn_newsb_03.png') no-repeat center center / 100% 100%; margin: 3% auto; padding: 0% 0;}
    ...
    .sub-txt {text-align: center; color: #ff0000; font-size: 115%;}
    ...
    @media screen and (max-width: 786px) {
        ...
        #page_landing_c .form .table_box input {padding: 1.5rem 1rem 1.5rem;
        font-size: 2rem;}
        ...
        #page-1 .intro-area .agBox {font-size: 50%;}
        #page-1 .intro-area .btn-agreement {font-size: 100%;}
        #page-1 .intro-area .content-box .paging button {height: 40px;}
    }
    @media screen and (max-width: 500px){
        .sub-txt {font-size: 85%;}
        ...
        .form .video-area::after {bottom: 8px; right: 8px; font-size: 7px;}
            ...
            <div class="form">
                ...
                <div class="formContents"> 
                    ...
                    <section class="page" id="page-1">
                        <div class="poster_01">
                            <div class="img-area intro-area">
                                <img src="//static.savemkt.com/event/v_${eventSeq}/event_main_01.jpg">
                                <div class="content-box">
                                    <div class="agBox">
                                        혜택 제공을 위한 <a href="javascript:void(0);" class="btn-agreement"><b>개인정보 처리방침</b></a>에 동의해주세요
                                    </div>
                            ...
                            <div class="img-area txt-area"><img src="//static.savemkt.com/event/v_${eventSeq}/txt_01.png"></div>
                        </div>
                    ...
                    <section class="page" id="page-2">
                        <div class="img-area logo-area"><img src="//static.savemkt.com/event/v_${eventSeq}/logo.png" alt=""></div>
                        ...
                        <div class="question_box">
                            <div class="q_select">
                                <label>
                                    <input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="무릎">
                                    <img src="//static.savemkt.com/event/v_${eventSeq}/select_01.png" alt="">
                                </label>
                                <label>
                                    <input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="허리">
                                    <img src="//static.savemkt.com/event/v_${eventSeq}/select_02.png" alt="">
                                </label>
                                <label>
                                    <input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="어깨">
                                    <img src="//static.savemkt.com/event/v_${eventSeq}/select_03.png" alt="">
                                </label>
                                <label>
                                    <input type="radio" onclick="setTimeout(show3pg, 100)" onclick="pageFuc(2,$(this))" name="tadd1" value="기타">
                                    <img src="//static.savemkt.com/event/v_${eventSeq}/select_04.png" alt="">
                                </label>
                            </div>
                        </div>
                    ...
                    <section class="page" id="page-4">
                        ...
                        <div class="img-area poster_10"><img src="//static.savemkt.com/event/v_${eventSeq}/q_02.png"></div>
                    ...
                    <div class="popup-confirm">
                        <p>
                            본 이벤트는 <br />
                            <strong>수도권 거주자</strong>만 신청 가능합니다.
                        </p>
                        <div class="btn-box">
                    ...
                    <div id="modal2" class="modal modal2" style="display: none;">
                        <div class="modal-content">
                            ...
                            <p>
                                - 개인정보 수집주체: 일양 관절건강 뼈건강 골다공증 파워솔루션<br />
                                - 개인정보 위수탁 업체: 주식회사 어썸바이오<br />
                                - 개인정보 제3자 제공자: 비올린<br />
                                - 개인정보 수집항목: 이름, 나이, 전화번호, 문의사항<br />
                                - 개인정보 수집 및 이용목적: 건강기능식품 판매 상담 활용 (전화, 문자)<br />
                                - 개인정보 보유 및 이용기간: 수집일로부터 6개월 (고객 동의 철회 시 지체없이 파기)
                            </p>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    agree.forEach(a => a.onclick = function () { modal2.style.display = "block"; })
