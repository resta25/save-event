...
<style>
    ...
    * {font-family: "Noto Sans KR", sans-serif; box-sizing: border-box;}
    ...
    #page_landing_c main {max-width: 820px; background-color: #000;}
    ...
    .img-area .btm_box {position: absolute; bottom: 7%; left: 50%; transform: translateX(-50%); width: 78.372093%; color: #000;}
    .img-area .btm_box .db_btn {animation: pulsating 0.8s linear infinite; -webkit-animation: pulsating 0.8s linear infinite;}
    #page_landing_c .btm_box .agBox label span {color: #000;}
    #page_landing_c  .img-area .btm_box .agBox {margin: 2% auto 0%; color: #000; transition: 0s;}
    ...
    #page_landing_c .wrap_form {background-color: #fff; padding: 54px 34px 30px !important;}
    ...
    #page_landing_c .description p {color: #000; padding: 0; font-weight: 300; font-size: 175%; letter-spacing: -0.02em;}
    ...
    #page_landing_c .description .target {color: #000; font-size: 175%; padding: 0; letter-spacing: -0.02em; font-weight: 300;}

    #page_landing_c .question {position: relative;}
    #page_landing_c .question_box {width: 87.627906%; margin: 0% auto 4%;}
    ...
    #page_landing_c .legend {flex-shrink: 0; position: relative; display: block; width: 15%; height: 35px; font-size: 167%; font-weight: 500; line-height: 1; letter-spacing: -1.78px; color: #000; text-align: justify;}
    #page_landing_c .legend::after {content: ''; display: inline-block; width: 100%;}
    #page_landing_c .agBox {text-align: center; display: flex; align-items: center; justify-content: center; color: #000; font-size: 180%; margin: 5% auto 3%;}
    ...
    /* 이름, 연락처 공통 */
    #page_landing_c .user_info input {background: #cfcfcf; padding: 2%; font-size: 150%; border-radius: 0.5rem; width: 67%;
    position: absolute; left: 29%; top: 14%; height: 70%; border: 1px solid #b3b3b3; }

    #page_landing_c .inp {font-size: 120%; border: 2px solid #b3b3b3; background-color: #fcfcfc; border-radius: 10px; min-height: 34px; padding: 1% 3%; box-sizing: border-box; margin-left: 0; transition: 0s;}
    #page_landing_c .inp::placeholder {color: #b3b3b3;}
...
<body id="page_landing_c" class="loaded">
    <main>
        ...
        <div class="img-area"><img src="//static.savemkt.com/event/v_${eventSeq}/event_main_06.jpg"></div>
            ...
            <div class="wrap_form">
                <form class="wrap_curd" id="form-1" method="POST" accept-charset="utf-8">
                    ...
                    <div class="img-area" style="margin: 3% 0 5%;"><img src="//static.savemkt.com/event/v_${eventSeq}/txt_01.jpg"></div>
        ...
        <div class="img-area"><img src="//static.savemkt.com/event/v_${eventSeq}/event_main_07.jpg"></div>
        <div class="img-area"><img src="//static.savemkt.com/event/v_${eventSeq}/event_main_08.gif"></div>
        ...
        <div class="wrap_form">
            <form class="wrap_curd" id="form-2" method="POST" accept-charset="utf-8">
                <div class="formGroup">
                    <div class="form_inner">
                        <div class="question_container">
                                <div class="img-area" style="margin: 3% 0 7%;"><img src="//static.savemkt.com/event/v_${eventSeq}/txt_02.jpg"></div>
                                <div class="question_box">
                                    <div class="user_name">
                                        <span class="legend">이름</span>
                                        <input type="text" name="name" id="name" class="inp" required placeholder="이름을 입력해 주세요" autocomplete="off">
                        ...
                        <div class="submit"><input type="image" value="" onclick="fnForm('form-2')" class="btn_submit" src="//static.savemkt.com/event/v_${eventSeq}/btn_newsb_03.png" /></div>	
                    </div>
