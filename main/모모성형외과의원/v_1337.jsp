...
/* 신청자 수 CSS */
.remaining-box {display: flex; align-items: center; justify-content: center; gap: 1em; width: 90%; margin: 0 auto; padding: 2.7em 0; text-align: center; border-radius: 1.2em; color: #fff; background-color: #000;}
.remaining-box .remaining-box-inner {font-size: 2.9em;font-weight: 500;line-height: 1;}
#eventCnt {color: #00ffff;}
...
.form {}
.form .formContents{    padding: 5em;}
.form .agBox{width: 100%; margin: 2.5rem auto; text-align: left; font-size: 2em; color: #000; font-weight: 300;}
.form label {display: grid;grid-template-columns: 14em 1fr;align-items: center;}
.form .q_select label {position: relative;display: flex;align-items: center;gap: 0.8em;}
...
.result_box #result { position: absolute; left: 14%; bottom: 27%; font-size: 2rem;}
...
.input_row {display: grid; grid-template-columns: 14em 1fr; align-items: center;}
.input_row + .input_row {margin-top: 1.4rem;}
.input_box .title {margin-bottom: 0.4em;font-size: var(--form-font-size);font-weight: 500;color: #000;}
.mark {color: #005fff;}
...
.input_row.age3 .q_select {display: flex;align-items: center;gap: 1em; justify-content: space-between;}
.input_row.age3 .q_select img {margin-right: 0.3rem;width: 16%;}

select.q_select {display: block;
    padding: 0.7em 0.8em;
    text-align: left;
    font-size: var(--form-font-size);
    border: 0.1em solid #dedede;
...
#banner_slide .slide-num {
    ...
    background-color: rgba(18, 74, 179, 0.5);
}
...
<div id="wrap"> 
    <div class="container">
            ...
            <div class="swiper-container" id="banner_slide">
                <div class="swiper-wrapper">
                    <div class="swiper-slide slide1 active">
                        ...
                        <div class="slide-description">이마만 살짝 채워볼 분 <br/>찾습니다</div>
                    </div>
                    <div class="swiper-slide slide2">
                        ...
                        <div class="slide-description">넓어지는 이마로<br/>고민이라면?</div>
                    </div>
                    <div class="swiper-slide slide3">
                        ...
                        <div class="slide-description">이마 3cm 줄이는 법<br/>알려드립니다</div>
                    </div>
                    <div class="swiper-slide slide4">
                        ...
                        <div class="slide-description">평균경력 14.5년<br/>모발이식 특화 의료진</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form   form id="form-1" method="POST" accept-charset="utf-8"> 
                    ...
                    <div class="img-area">
                        ...
                        <div class="video_slide">
                            <div class="video_container">
                                <video id="location" playsinline="" muted="" loop="" src="//static.resta.co.kr/event/v_${eventSeq}/250228.mp4" type="video/mp4"></video>
                ...
                <div class="age-box age4">
                    <div class="video_box relative">
                        ...
                        <video id="location2" playsinline="" muted="" loop="" src="//static.resta.co.kr/event/v_${eventSeq}/240717.mp4" type="video/mp4"></video>
                        <script>setTimeout(function(){ $('#location2').trigger('play'); },500);</script>	
                    </div>
                </div>

                <div class="remaining-box">
                    <div class="remaining-box-inner">
                        현재까지 <span id="eventCnt"></span>명이 신청했습니다.
                    </div>
                </div>
                ...
                <div class="formContents">
                    <div class="input_box">
                        <div class="input_row age3">
                            <span class="title">고민부위<span class="mark">*</span></span>
                            <div class="q_select">
                                <label><input class="blind" type="radio" name="tadd1" value="M자이마"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off.png"><span>M자이마</span></label>
                                <label><input class="blind" type="radio" name="tadd1" value="전체이마"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off.png"><span>전체이마</span></label>
                                <label><input class="blind" type="radio" name="tadd1" value="정수리"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off.png"><span>정수리</span></label>
                                <label><input class="blind" type="radio" name="tadd1" value="여러부위"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off.png"><span>여러부위</span></label>
                            </div>
                        </div>
                    ...
                    <div class="agreement">
                        <h3>개인정보 수집 • 이용 동의</h3>
                        <ol>
                            <li>모모성형외과의원은(는) 아래와 같이 회원님의 개인정보를 수집ㆍ이용하기 위하여 회원님의 동의를 받고자 합니다.</li>
                            <li>1. 개인정보의 수집ㆍ이용 목적 : 병원 상담 신청 서비스 제공</li>
                            <li>2. 수집하는 개인정보의 항목 : 이름,나이,연락처</li>
                    ...
                    <div class="mkt_agreement">
                        ...
                        <ol>
                            ...
                            <li>2. 수집항목 : 이름,나이,연락처 ,상담신청하는 시술</li>
                            <li>3. 보유및 이용기간 : 6개월</li>
                        </ol><br/>
                        <h3>동의를 거부할 권리가 있다는 사실 및 동의 거부에 따른 불이익</h3>
                        <ol>
                    ...
                    <div class="submit"><input type="image" onclick="fnForm('form-1')" value="" src="//static.resta.co.kr/event/v_${eventSeq}/btn-newsb.png"></div>
                </div>
        ...
        <div class="result_box">
            <div class="img-area">
                <img src="//static.resta.co.kr/event/v_${eventSeq}/event-main.png">
                <span id="result"></span>
...
<script>
    ...
    const banner_swiper = new Swiper("#banner_slide", {
        ...
        slidesOffsetBefore: 30, // 좌측 여백
        slidesOffsetAfter: 30, // 우측 여백
        breakpoints: {
            365: {
                spaceBetween: 25,
            }
