...
.floating_box .formContents{padding: 10% 5% 0; background: url("//static.resta.co.kr/event/v_${eventSeq}/event_main_04.png") no-repeat center / 100% 100%; 
		...
		<section class="floating_box">
            <div class="formContents">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" value="gangnam" name="branch" class="inp" id="branch" required="" autocomplete="off">
                </div>
