...
<style>
    ...
    #page_landing_c .wrap_form .agBox .ag_btn {left: 55%; flex-grow: 1; margin-left: 3%;}
...
@media screen and (max-width: 768px){
    ...
    [class^="popup-"] {width: 90vw; font-size: 3.5vw; border-radius: 20px; top: 57%;}
...
@media screen and (max-width: 480px){
    ...
    #page_landing_c .wrap_form .agBox .disagree {width: 30%; font-size: 75%;}
