...
.page .paging button img {width: 61.46% !important; margin: 0 auto; animation: pulsating 0.8s linear infinite;
    ...
    .form .formContents .description * {font-family: 'GmarketSans'; font-weight: 300; color: #fff; font-family: 'GmarketSans';}
    ...
    .form .table_box input {background: #ededed; border-radius: 1.9rem; font-size: 2.8rem; border: none; background: transparent; width: 100%; padding: 2rem 0 1.5rem 1.5rem; font-family: 'GmarketSans'; font-weight: 500;}
