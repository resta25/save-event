...
<style>
    ...
    #page_landing_c .wrap_form .agBox .disagree{display: inline-block; border-radius:0.5rem; font-size: 100%; text-align: center;  color: #0a151e; font-weight: 800; cursor: pointer; width: 27%; padding: 3% 2%; border:1px solid #bebebe;}
    #page_landing_c .wrap_form .agBox .disagree {margin-right: 0;}
     #page_landing_c .wrap_form .question_box .q_select label + label {margin-left: 1%;}
                                ...
                                <div class="question_box">
                                    ...
                                    <div class="agBox">
                                        <div class="question">
                                            ...
                                            <a href="#">
                                                <span class="btn-agreement">[자세히 보기]</span>
