...
/* 개인정보처리방침 관련 */
.form .agBox{margin: 0 auto; padding: 5% 0 0; font-size: clamp(10px, 3vmin, 28px); color: #fff; text-align: center;}
.form .agBox .btn-agreement{text-decoration: underline; font-weight: 700; color: #fff; font-size: 100%;}
...
/* description */
.form .description{padding: 0 0 8vmin; text-align: center;}
...
.form-group .inp{padding: 4% 3%; border: 0; text-align: center; font-size: clamp(14px, 5vmin, 1.5rem);}

/* cta 버튼 */
.form .submit{width: 70%; margin: 0 auto; padding: 0 0 5%;}
.form .submit input[type="image"]{width: 100%; height: 100%; padding: 0;}
...
input:not( [type="checkbox"], [type="radio"], [type="range"] ), select {height: 100%;}
...
@media screen and (max-width: 500px){
    #page_landing_c input:not( [type="checkbox"], [type="radio"], [type="range"] ), select {padding: 4% 3%;}
        ...
        <div id="wrap"> 
            <div class="form">
                ...
                <section class="page" id="page-1">
                    ...
                    <div class="agBox">
                            <a href="javascript:void(0);" class="btn-agreement">개인정보 처리방침</a> 동의 후 <br />불편한 목, 어깨 치료 받으세요.
                        </div>
                ...
                <section class="page" id="page-2">
                    ...
                    <div class="description">
                        <b id="event-period">이벤트 기간 : <?=date("Y년 m월 01일")." ~ ".date("Y년 m월 t일 까지")?></b>
