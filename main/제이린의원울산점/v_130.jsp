...
<style>
    ...
    :is(#page_landing_a, #page_landing_c) .wrap_curd .btn_submit {line-height: 1.5 !important;}
                ...
                <form class="wrap_curd" id="form-1" method="POST" accept-charset="utf-8">
                    ...
                    <ul class="layout_add02">
                        <li>
                            ...
                            <label><input type="radio" name="tadd1" value="볼패임" class="answer">볼패임</label>
                            <label><input type="radio" name="tadd1" value="모공" class="answer">모공</label>
