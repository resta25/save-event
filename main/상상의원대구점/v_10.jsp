                ...
                <form class="wrap_curd" id="form-1" method="POST" accept-charset="utf-8">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>*나이</th>
                                <td><input type="tel" placeholder="나이를 입력해주세요." id="age" name="age" maxlength="2" value=""></td>
                            </tr>
                            <tr>
                                <th>*휴대폰번호</th>
                                <td><input type="tel" placeholder="연락처를 입력해주세요." id="phone" name="phone" maxlength="11" value=""></td>
                            </tr>
                        </tbody>
                    </table>
