...
@font-face {
    ...
    * {font-family: 'Presentation', sans-serif; box-sizing: border-box;}
    ...
    #page_landing_c main {max-width: 818px;}
    ...
    .gif-area, .count-area {position: relative;}
    #page_landing_c main .gif-area .gif {position: absolute; top: 18%; left: 50%; transform: translateX(-50%); width: 92.04%;}
    #page_landing_c main .count-area .count-box {position: absolute;
    top: 40.5%;
    font-weight: 500;
    left: 50%;
    ...
    display: flex;
    align-items: center;
    justify-content: center; font-size: 250%; font-weight: 500;}
    #page_landing_c main .count-area .count-box strong,
    #page_landing_c main .count-area .count-box .count {color: #fdd325; font-size: 100%; font-weight: 700;}
    ...
    #page_landing_c .wrap_form {background: linear-gradient(0deg, #593c3f 90%, #352526 100%); padding: 54px 35px 57px !important; border: none !important;}
    ...
    #page_landing_c .description p, #page_landing_c .description .ad_txt {text-align: center; color: #fff;  font-family: 'Presentation'; font-size: 125%;}
    .wrap_form .description .ad_txt {padding: 1% 0;}

    #page_landing_c .description {width: 100%; padding: 0 3.9% 0; text-align: center;  font-family: 'Presentation'; font-size: 20px; font-weight: 600;}
    #page_landing_c .description p {color: #fff; padding: 0; font-weight: 400; font-size: 125%; letter-spacing: -0.02em;}
    #page_landing_c .description .ad_txt b {color: #fff640; font-size: 100%; letter-spacing: -0.02em; font-weight: 400;}
   .wrap_form .description span {padding: 0; color: #fff;}
    ...
    #page_landing_c .agBox label span {color: #fff; font-family: 'Presentation';} 

    .selected_area{background-color:#000; padding:3% 5%;}
    .question_box > div {display: flex; align-items: center; background-color: #23191a; border-radius: 8px; padding: 29px 33px 31px;}
    .question_box > div.user_info {align-items: flex-start;}
    .question_box > div.user_info .legend {width: 101px;}
    ...
    #page_landing_c .inp {color: #fff; font-size: 125%;}
    /* #page_landing_c .inp:focus {color: #000;} */
    #page_landing_c .inp::placeholder {color: rgba(255, 255, 255, 0.5);}
    #page_landing_c input[type="checkbox"] + span:before {border-color:#fff;}
        .wrap_curd textarea {margin: 0; margin-left: 10px; padding: 0; padding-left: 10px;}
...
@media screen and (max-width: 768px){
    ...
    #page_landing_c .formGroup .user_info {font-size: 4vw;}
...
@media screen and (max-width: 480px){
    ...
    #page_landing_c .description p {font-size: 60%;}
    ...
    #page_landing_c .legend {width: 41%;}
    #page_landing_c .question_box > div.user_info .legend {width: 27%;}
    #page_landing_c .inp {font-size: 100%;}
    ...
    #page_landing_c .agBox {margin-top: 5%;}
                        ...
                        <div class="form_inner">
                            <div class="question_container">
                                <div class="question_box">
                                    <div class="user_name">
                                        <span class="legend"><img src="//static.savemkt.com/event/v_${eventSeq}/q_01.png"></span>
                                        <input type="text" name="name" id="name" class="inp" required placeholder="이름" autocomplete="off">
                                    </div>
                                    <div class="user_age">
                                        <span class="legend"><img src="//static.savemkt.com/event/v_${eventSeq}/q_02.png"></span>
                                        <input type="tel" name="age" id="age" class="inp" required=""  placeholder="나이" autocomplete="off" maxlength="2" placeholder="">
                                    </div>
                                    <div class="user_phone">
                                        <span class="legend"><img src="//static.savemkt.com/event/v_${eventSeq}/q_03.png"></span>
                                        <input type="tel" name="phone" id="phone" class="inp" required placeholder="연락처" autocomplete="off" maxlength="11">
                                    </div>
                                    <div class="user_info">
                                        <span class="legend"><img src="//static.savemkt.com/event/v_${eventSeq}/q_04.png"></span>
                                        <textarea name="tadd1" id="tadd1" class="inp" required="" rows="4" autocomplete="off"></textarea>
                                    </div>
                                </div>   
                            </div>
