...
<style>
    ...
    * {font-family: "Pretendard", sans-serif; box-sizing: border-box;}
    ...
    #page_landing_c .wrap_form {background-color: #fff; padding: 43px 9.45% 30px !important;}
    ...
    #page_landing_c .inp {font-size: 315%; line-height: 1; border: 7px solid #333364; color: #00003d; min-height: 34px; padding: 2.674% 3%; box-sizing: border-box; margin-left: 0; border-radius: 2rem; transition: 0s; text-align: center;}
