...
<style>
    ...
    .question_box .text span:first-child{display: inline-block; padding:0 0 5%; font-weight: 700; color: #11932f;}
    ...
    #page-1 .question_box .answer .inputBox input{padding:2%; background-color: #fff; border-radius: 0.5em; border: 1px solid #7aee41; font-size: 140%;}
    ...
    .subscribe_chat_box .number{display: flex; justify-content: center; align-items: center; width: 30px; height: 30px;margin-right:10px;background-color: #11932f; border-radius: 50%; color: #ffffff; font-size: 100%; font-weight: 700;}
    .subscribe_chat_box .pushAlarm{position: absolute; bottom:50%; width:55%; height: auto; padding:2% 6%; background-color: #ffb6cc !important; border-radius: 0.7em 0 0.7em 0; opacity: 1 !important; font-size:130%; line-height: 1.2; color: #000 !important; font-weight: normal;}
                ...
                <section class="page" id="page-2">
                    <div class="question_box">
                        <div class="text">
                            ...
                            <span>
                            <b class="pointColor">49%할인</b>으로 <br>
                            <b class="pointColor">오스템 임플란트</b>를 해드립니다.<br>
                            개인 정보 처리 방침에 동의하시나요?
                        </span>
                        </div>
                    </div>
