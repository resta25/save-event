...
<style>
    ...
    * {font-family: "Presentation", sans-serif; box-sizing: border-box;}
    ...
    .img-area .btm_box {position: absolute; bottom: 7%; left: 50%; transform: translateX(-50%); width: 78.372093%; color: #fff;}
    ...
    #page_landing_c  .img-area .btm_box2 {bottom: 2%;}
    ...
    #page_landing_c .wrap_form {padding-top: 0; background-color: #181713;}
    #page_landing_c .wrap_curd {padding: 4% 0 2%; background-color: #fff;}
    #page_landing_c .wrap_curd .question_container {padding-top: 0 !important;}
    #page_landing_c .wrap_curd#form-2 .q_text.img-area {width: 73.240741%; margin: 0 auto 5%;} 
    ...
    #page_landing_c .question_box {width: 71.627906%; margin: 0 auto 4%;}
    ...
    #page_landing_c .agBox {text-align: center; display: flex; align-items: center; justify-content: center; color: #000; font-size: 180%; margin: 7% auto 3%; font-family: 'Presentation';}
    ...
    .agBox a {color: #0600fe; text-decoration: underline;}
    ...
    #page_landing_c .submit {margin: 0 auto; padding: 0; text-align: center;}
    #page_landing_c .submit input[type="image"] {
        width: 90%;
        margin: 0 auto 0;
    }
        ...
        <div class="img-area"><img src="//static.savemkt.com/event/v_${eventSeq}/event_main_07.jpg"></div>
            ...
            <form class="wrap_curd" id="form-2" method="POST" accept-charset="utf-8">
                <div class="formGroup">
                    ...
                    <div class="submit"><input type="image" value="" onclick="fnForm('form-2')" class="btn_submit" src="//static.savemkt.com/event/v_${eventSeq}/btn_newsb_02.png" /></div>	
                </div>
