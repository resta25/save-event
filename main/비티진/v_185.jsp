...
<style>
    ...
    * {font-family: "Noto Sans KR", sans-serif; box-sizing: border-box;}
    ...
    #page_landing_c .description .target {color: #fff; font-size: 175%; padding: 0; letter-spacing: -0.02em; font-weight: 300;}
    ...
    #page_landing_c .legend {position: relative; display: block; margin-bottom: 2.35%; width: 100%; padding-left: 65px; font-size: 280%; font-weight: 500; line-height: 1; letter-spacing: -1.78px; color: #fff;}
    #page_landing_c .legend::before {content: '*'; font-size: 100%; color: #ff0000; position: absolute; left: 15px;}
    #page_landing_c .agBox {text-align: center; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 180%; margin: 7% auto 6%;}
    ...
    #page_landing_c .inp{font-size: 120%; border-radius: 30px; border: 6px solid #fff; min-height: 34px; padding: 3%; box-sizing: border-box; margin-left: 0; background-color: #4d4d4d; color: #fff;}
    #page_landing_c .inp::placeholder{color: rgba(255, 255, 255, 0.35);}
    ...
    #page_landing_c .wrap_curd .submit {margin: 0 auto; padding: 3.2% 0; background: url('//static.savemkt.com/event/v_${eventSeq}/btn_newSb.png') no-repeat center center / 100% 100%;}
...
@media screen and (max-width: 768px){
    ...
    #page_landing_c .legend {padding-left: 35px; line-height: 27px;}
...
@media screen and (max-width: 480px){
    #page_landing_c main {padding-bottom: 5rem;}
    #page_landing_c .description {padding: 3.37% 0 1.37%;}
    #page_landing_c .description p {font-size: 100%;}
    #page_landing_c .description .ad_txt, #page_landing_c .description .target {font-size: 100%;}
    #page_landing_c .agBox label span {font-size: 90%;}
    #page_landing_c .agBox a {font-size: 50%;}
    #page_landing_c .wrap_form {padding: 50px 20px 30px !important;}
    ...
    #page_landing_c input:not( [type="checkbox"], [type="radio"], [type="range"], [type="image"] ), select { font-size: 105%; border-radius: 15px; border: 3px solid #fff; padding: 2% 3%;}
...
<body id="page_landing_c" class="loaded">
    <main>
        ...
        <div class="img-area on-off-img"><img src="//static.savemkt.com/event/v_${eventSeq}/event_main_02_01.jpg"></div>
