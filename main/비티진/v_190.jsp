...
@font-face {
    ...
    * {font-family: 'Pretendard', sans-serif; box-sizing: border-box;}
    ...
    #page_landing_c .wrap_form {background-color: #fff; padding: 0 34px 70px !important; border: none !important;}
...
@media screen and (max-width: 480px){
    ...
    #page_landing_c .wrap_form {padding: 0 20px 30px !important;}
