                ...
                <form class="wrap_curd" id="form-1" method="POST" accept-charset="utf-8">
                    ...
                    <ul class="layout_add02">
                        <li>
                            ...
                            <label><input type="radio" name="tadd1" value="앞광대" class="answer">앞광대</label>
                            ...
                            <tr>
                                ...
                                <td class="branch_td">
                                    <div class="wrap_radio">
                                        <label><input type="radio" name="branch" class="store-radio"> 홍대 </label>
                                    </div>
                                    <script>
