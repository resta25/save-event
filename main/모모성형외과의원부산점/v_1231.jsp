...
<div id="wrap"> 
    ...
    <div class="form">
        ...
        <div class="grid_box">
            ...
            <input type="hidden" name="branch" id="branch" class="inp" required="" value="seomyeon">
        </div>
		...
		<div class="formContents">
			...
			<div class="agBox">
				<label><input name="agBox" type="checkbox"><span>개인정보수집이용동의</span></label> <a href="avascript:void(0);" class="btn-agreement">[자세히 보기]</a>
			</div>
            <div class="agreement">
...
<script>
    ...
    function fnForm(formId){
		...
		// 라디오버튼에 대한 필수값 확인 - 체크된게 하나도 없을때 경고창
		let selectedRadio2 = procForm.querySelector('input[name="tage"]:checked');
		if (!selectedRadio2) {
			alert("나이를 선택해주세요.");
			return;
		} else {
			procForm.querySelector("input[name='age']").value = selectedRadio2.value;
		}
