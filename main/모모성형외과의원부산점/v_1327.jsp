...
.page .paging label img {width:100%; cursor:pointer;}
        ...
        <div class="formContents"> 
            ...
            <section class="page" id="page-1">
                ...
                <p class="paging poster_02">
					<label onclick="show2pg()" class="first"><input name="agBox" type="checkbox"><img src="//static.resta.co.kr/event/v_${eventSeq}/btn_newSb_01.png"></label>
                </p>
            </section>
            ...
            <section class="page" id="page-3">
                ...
                <div class="question_box">
                    <div class="q_select">
                        <label><input type="radio"  name="age" value="20">20대</label>
                        <label><input type="radio"  name="age" value="30">30대</label>
                        <label><input type="radio"  name="age" value="40">40대</label>
                        <label><input type="radio"  name="age" value="50">50대 이상</label>
                    </div>
                </div>
...
let isAnimating = false; // 애니메이션 상태 플래그
    ...
    function fnForm(formId){
		...
		// 라디오버튼에 대한 필수값 확인 - 체크된게 하나도 없을때 경고창
		let selectedRadio2 = procForm.querySelector('input[name="age"]:checked');
		if (!selectedRadio2) {
			alert("나이를 선택해주세요.");
			return;
		} else {
