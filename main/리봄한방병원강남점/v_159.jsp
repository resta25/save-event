...
.count_box {width: 70%; text-align: center; font-size: 2.8rem; color: #fff; position: absolute; top: 35.5%; left: 54%; transform: translateX(-50%);}
.count {color: #fff799; font-size: 2.8rem;}
...
.form .question_box .q_select {display: flex; flex-direction: column;}
...
.form .table_box input {background: #ededed; border-radius: 0.8rem; font-size: 1.5rem; border: none; background: transparent; width: 100%; padding: 1.5rem 0 1.5rem 2rem;}
...
/* 개인정보 처리방침 */
.btn-agreement {font-size: 1rem; text-align: center; font-weight: 700; display: block; color: #757474; font-weight: normal; padding-bottom: 5%;}
            ...
            <div class="form">
                ...
                <div class="formContents"> 
                    ...
                    <section class="page" id="page-2">
                        ...
                        <div class="next_btn_inQuestion"><img src="//static.savemkt.com/event/v_${eventSeq}/btn_newSb_03.png" onclick="pageSelFuc(2,$(this))"></div>
                    </section>
                    ...
                    <!-- <section class="page" id="page-4">
                        ...
                        <div class="next_btn_inQuestion"><img src="//static.savemkt.com/event/v_${eventSeq}/btn_newSb_03.png" onclick="pageSelFuc(3,$(this))"></div> 
                    </section> -->
        
                    <section class="page" id="page-4">
                        <div class="img-area poster_09"><img src="//static.savemkt.com/event/v_${eventSeq}/gage_04.png"></div>
                        ...
                        <div class="form-box poster_11">
                            <div class="formGroup">
                                ...
                                <div class="submit"><input type="image" onclick="fnForm('form-1')" value="" class="btn_submit" src="//static.savemkt.com/event/v_${eventSeq}/btn_newSb_04.png" /></div>
                            </div>
