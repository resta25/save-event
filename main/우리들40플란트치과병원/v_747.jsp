...
.form {position: absolute; top: 0%; left: 50%; transform: translateX(-50%); width: 90%; background: none;}
...
.paging button{width:49%; box-sizing: border-box; background: none; padding: 0; cursor: pointer;}
.paging button img{width:100%;}
.paging button a{display:block;}
...
<div class="agBox_box">
    ...
    <p class="paging">	
        <button type="button" class="first"><img src="//static.resta.co.kr/event/v_${eventSeq}/btn_newSb_01.png"></button>
        <button type="button" class="close"><img src="//static.resta.co.kr/event/v_${eventSeq}/btn_newSb_02.png"></button>
    </p>
    <!-- <audio id="location2" playsinline><source src="//static.resta.co.kr/event/v_${eventSeq}/audio_02.mp3" type="audio/mp3"></source></audio> -->
</div>
...
<div id="wrap"> 
    ...
    <div class="form">
        ...
        <div class="img-area" style="margin-top: 5%;"><img src="//static.resta.co.kr/event/v_${eventSeq}/event_main_02.png"></div>
		...
		<div class="formContents">
            <section class="page" id="page-1">             
                <div class="question_box">
					...
					<div class="q_select">
						<label><input type="radio" name="tadd1" value="지원받기"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off_01.png"></label>
						<label><input type="radio" name="tadd1" value="실시간 예약하기"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off_02.png"></label>
						<label><input type="radio" name="tadd1" value="병원위치 문의"><img src="//static.resta.co.kr/event/v_${eventSeq}/select_off_03.png"></label>
			...
			<section class="page" id="page-2">
                ...
                <!-- <audio id="location3" playsinline><source src="//static.resta.co.kr/event/v_${eventSeq}/audio_03.mp3" type="audio/mp3"></source></audio> -->
			</section>
		</div>
