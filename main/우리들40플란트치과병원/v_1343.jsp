...
.agreeModalBox .newAgreement h3 {margin: 1% 0; font-size: 100%;}
.agreeModalBox .newAgreement ol li {font-size: 65%;}
...
</div><!--공통_script start --><script src="/js/form-event.js"></script><!--공통_script end-->
<script>
