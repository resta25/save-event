...
.form {padding: 5%;}
/* db영역 */
.form .db-box {background: #343434; padding: 5% 10%; border: 1px solid #ff4948;}
.form .input_row {display: flex; align-items: center; background: #fff; padding: 2%; margin-bottom: 2%;}
.form .input_row:nth-child(4){flex-flow: column; align-items: self-start;}
.form .input_row .title {width: 20%; font-size: 1.2rem; color: #a0a0a0;}
.form .input_row textarea,
.form .input_row input {font-size: 1.2em;  padding: 2%;}

.form .agBox { margin: 2% auto; font-size: 110%; color: #fff;}
.form .agBox a {color: #ffea00;}
.form input[type="checkbox"] + span:after, .form input[type="radio"] + span:after {border-color: #ffea00;}
.form .submit input[type="image"] {width: 100%;}

.form .description.top {background: #494949; padding: 2%; border-radius: 0.8em; width: auto; margin-bottom: 3%;}
.form .description span,
.form .description .ad_txt {color: #fff;}
.form .description p {color: #ffea00; font-weight: normal; font-size: 120%;}
...
<div id="wrap">
    ...
    <div class="form">
        <form id="form-1" method="POST" accept-charset="utf-8"> 
            ...
            <div class="db-box">
                ...
                <div class="agBox">
                    <label><input name="agBox" type="checkbox" checked><span>개인 정보 수집 및 이용에 관한 내용을 확인하고 동의함</span></label> <a href="https://ggad01.co.kr/dang/privacy.html" target="_blank" onclick="window.open(this.href, this.target,'resizable=no, scrollbars=yes, width=1000, height=800, left=200, top=200'); return false;" >[자세히 보기]</a>
                </div>
                <div class="submit">
    ...
    <div class="img-area"> <img src="//static.resta.co.kr/event/v_${eventSeq}/event_main_08.png"> </div>
