...
@font-face {
    ...
    * {font-family: 'Pretendard', sans-serif; box-sizing: border-box;}
    ...
    #page_landing_c main {max-width: 1200px; background-color: #fff;}
    ...
    #page_landing_c .wrap_form {background-color: #fff; padding: 20px 74px 70px !important; border: none !important;}
    ...
    #page_landing_c .question_box > div:not(.formContents) + div:not(.formContents) {margin-top: 4.61%;}
    ...
    #page_landing_c .agBox {text-align: center; display: flex; align-items: center; justify-content: center; color: #000; font-size: 180%; margin: 7% auto 6%; }
    ...
    #page_landing_c .inp{font-size: 120%; border-radius: 0; border: 3px solid #6e6e6e; min-height: 34px; padding: 3%; box-sizing: border-box; margin-left: 0; background-color: #fff; color: #000;}
...
@media screen and (max-width: 480px){
    ...
    #page_landing_c .wrap_form {padding: 20px 40px 30px !important;}
