...
<style>
    ...
    * {font-family: "Pretendard", sans-serif; box-sizing: border-box;}
    ...
    #page_landing_c .wrap_form {border: 0; padding: 9rem 12.1rem 5rem; box-sizing: border-box;}
    html{height: 100%;}
    ...
    #page_landing_c .question_box [class^="user_"] .legend {flex-shrink: 0; width: 12.5rem; font-size: 3.6rem; font-weight: 700;}
...
@media screen and (max-width: 480px){
    ...
    .question_box {margin-top: 7rem;}
    #page_landing_c .wrap_form {padding: 7rem 7.1rem 4rem;}
...
<body id="page_landing_c" class="loaded">
    <main>
        ...
        <div class="img-area"><img src="//static.savemkt.com/event/v_${eventSeq}/event_main_07.jpg"></div>
                            ...
                            <div class="question_container">
                                ...
                                <div class="question_box">
                                    ...
                                    <div class="user_gender">
                                        ...
                                        <label><input type="radio" name="tadd1" class="store-radio" value="여성" checked><span>여성</span></label>
                                        <label><input type="radio" name="tadd1" class="store-radio" value="남성"><span>남성</span></label>
                                    </div>
                                    <div class="user_text">
                                        <span class="legend">키</span>
                                        <input type="tel" name="tadd2" class="inp" value="" required placeholder="숫자만 입력해주세요">
                                    </div>
                                    <div class="user_text">
                                        <span class="legend">체중</span>
                                        <input type="tel" name="tadd3" class="inp" value="" required placeholder="숫자만 입력해주세요">
                                    </div>
                                    <div class="user_text">
                                        <span class="legend">희망목표</span>
                                        <input type="tel" name="tadd4" class="inp" value="" required placeholder="숫자만 입력해주세요">
                                    </div>
                                </div>   
                            </div>
            ...
            <div class="img-area"><img src="//static.savemkt.com/event/v_${eventSeq}/event_main_08.jpg"></div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        thisAgreementWithText(`개인정보처리방침
            ...
            세일업(이하 “회사”)은 개인정보보호법 등 관련 법령을 준수하며, 정보주체의 권익 보호를 위해 개인정보를 적법하고 안전하게 처리합니다. 회사는 본 개인정보처리방침을 통해 개인정보의 수집·이용 목적, 처리 및 보유기간, 제3자 제공 및 위탁, 정보주체의 권리 등을 안내드립니다.
    ...
    // 23명 -> 7명은 빠르게, 7명 -> 3명은 천천히 감소 후 3명에서 정지
    let currentCount = 23;
    const minCount = 3;
    const fastPhaseEnd = 7;
    ...
    function decreaseCount() {
        ...
        const nextDelay = currentCount > fastPhaseEnd ? fastDelay : slowDelay;
        setTimeout(decreaseCount, nextDelay);
    }

    setTimeout(decreaseCount, fastDelay);
	...
	function fnForm(formId){
		...
		let selectedRadio2 = procForm.querySelector('input[name="tadd2"]');
		if (!selectedRadio2) {
			alert("키를 입력해주세요.");
			return;
		} else {
		...
		let selectedRadio4 = procForm.querySelector('input[name="tadd4"]');
		if (!selectedRadio4) {
			alert("희망목표를 입력해주세요.");
			return;
		} else {
