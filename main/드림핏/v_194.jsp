...
<style>
    ...
    * {font-family: 'GmarketSans', sans-serif; box-sizing: border-box;}
    ...
    #page_landing_c main .count-area .count-box, #page_landing_c main .count-area .count {position: absolute; top: 27.32%; font-weight: 500; left: 50%; transform: translateX(-50%); width: 73.34%;}
    #page_landing_c main .count-area .count {top: 57%; left: 20%; font-family: 'GmarketSans'; font-size: 290%; width: 12%;}
    ...
    #page_landing_c .wrap_form {background: url('//static.savemkt.com/event/v_${eventSeq}/bg.png') no-repeat center center / 100% 100%; padding: 54px 35px 57px !important; border: none !important;}
    #page_landing_c .wrap_curd {background-color: #fff; border-radius: 50px; padding: 55px 48px 36px;}
   ...
   .wrap_form .description span {padding: 0;}
    ...
    #page_landing_c .inp {width: 100%; padding: 43px 20px; border: 3px solid #000; text-align: center; font-size: 40px; font-weight: 300; font-family: 'GmarketSans'; border-radius: 30px; background-color: transparent; margin-left: auto; transition: 0; animation: none;}
    #page_landing_c .inp:focus {color: #000;}
    #page_landing_c .inp::placeholder {color: #373737;}
    #page_landing_c input[type="checkbox"] + span:before {border-color:#000;}
...
@media screen and (max-width: 820px){
    ...
    #page_landing_c main .count-area .count {top: 58%; left: 21%; font-size: 210%;}
}
