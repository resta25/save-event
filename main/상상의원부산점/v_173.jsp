                        ...
                        <tr>
                            ...
                            <td class="branch_td">
                                <div class="wrap_radio">
                                    <label><input type="radio" name="branch" class="store-radio store-radio1"> 부산점 </label>
                                </div>
                                <script>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="branch_td">
                                <div class="wrap_radio">
                                    <label><input type="radio" name="branch" class="store-radio store-radio2"> 부산점 </label>
                                </div>
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
