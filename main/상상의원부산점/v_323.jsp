...
<style>
    ...
    * {font-family: "Noto Sans KR", sans-serif; box-sizing: border-box;}
    ...
    .wrap_form .agBox {width: 100%; margin: 7px auto;}
    ...
    #page_landing_c .form .form_bg_box {padding: 4rem 3.7rem 0; background-color: #cae7f8; border-radius: 36px;}
    ...
    #page_landing_c .form .legend {width: 25%; text-align: right; display: inline-block; color: #030303; font-size: 2.5rem; font-weight: 700; flex-shrink: 0; font-family: 'GmarketSans';}
    #page_landing_c .form .form_box .user-info input, #page_landing_c .form .form_box .user-info select {background: #fff; height: auto; border: solid 1px #757575; padding: 1.5rem; padding-right: 0; font-size: 1.2rem; border-radius: 0;}
                            ...
                            <div class="form_box">
                                <div class="user-info">
                                    ...
                                    <div class="wrap_radio">
                                        <label><input type="radio" name="branch" class="store-radio"> <span>상상부산점</span> </label>
                                    </div>
                                    <script>
