...
.form .input_box .input_row:last-of-type {grid-column: 1/3;}
        ...
        <form id="form-1" method="POST" accept-charset="utf-8">
            ...
            <div class="formContents">
                ...
                <div class="input_box">
					...
					<input type="hidden" id="branch" name="branch" value="대전점"/>
                </div>
