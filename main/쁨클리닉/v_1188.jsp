...
.question_container{padding: 0 8% 3%;}
...
.form .question_box.row {display: grid; grid-template-columns: 1.2fr 4fr; gap: 1em;}
...
@media screen and (max-width: 500px){
    ...
    .form .question_box.row .q_select label, .form .question_box.row .q_select .inp {font-size: 3.2vw;}
    ...
    <div class="form">
        <form id="form-1" method="POST" accept-charset="utf-8"> 
            <div class="question_container">
                <div class="question_box row active" data-value="1">
                ...
                <div class="question_box row disabled" data-value="2">
                    ...
                    <div class="q_select">
                        <input type="tel" name="phone" id="phone" class="inp" data-value="2" onkeyup="enableNextEl(this);" required="" autocomplete="off" maxlength="11" placeholder="연락처를 입력해 주세요">
                    </div>
                </div>
                ...
                <!-- <div class="question_box row disabled" data-value="4">
                    ...
                    <div class="q_select">
                        <label><input type="radio" name="branch" data-value="4" onclick="enableNextEl(this);" value="강남" disabled><span>강남</span></label>
                        <label><input type="radio" name="branch" data-value="4" onclick="enableNextEl(this);" value="신논현" disabled><span>신논현</span></label>
                    </div>
                </div> -->
            </div>
            ...
            <div class="txtPrintBox cursor_box">
                <div id="result"></div>
                <img class="namePrint" src="//static.resta.co.kr/event/v_${eventSeq}/event_main_02.jpg">
			...
			<input type="hidden" id="branch" name="branch" value="울산"/>
...
<script>   
    ...
    // 이미지 변경 스크립트 추가
    $('input[name="tadd1"]').change(function() {
		console.log($(this))
        if ($(this).is(':checked')) {
