...
/* 셀렉 */
.tab-menu-bg {background: url("//static.resta.co.kr/event/v_${eventSeq}/bg_01.jpg"); padding-bottom: 5%;}
...
/* 지점 select */
.formGroup .gridBox select {appearance: none; background: url("//static.resta.co.kr/event/v_${eventSeq}/icon.png") no-repeat ; background-size: 15px; background-color: #f1f1f1; font-size: 18px; padding: 1.3rem 1rem; border-radius: 0.4rem; border: none; text-align: center; text-align-last: center;
