...
.count_box {width: 100%; text-align: center; font-size: 150%; position: absolute; top: 10%; left: 52%; transform: translateX(-50%);}
/* .count {color: #fff799;} */

/* 시침, 초침 */
.container {position: relative;}
.clock{position: absolute; top: 14.5%; left: 28%; background-color: #434f59; transition : all 0.05s; transition-timing-function : cubic-bezier(0.1, 2.7, 0.58, 1); transform-origin : 100%;}
.hourHand{width: 1.5%; height: 2px; transform: translate(-50%, -50%) rotate(0deg);}
.secondHand{left: 27.5%; width: 2.5%; height: 2px; transform: translate(-50%, -50%) rotate(0deg);}

.form .agBox {font-family: 'noto sans kr';}
.form .description {margin-bottom: 3%;}

@media screen and (max-width: 500px){
	.count_box {font-size: 85%;}
...
<div id="wrap">
    <div class="form">
		...
		<div class="container">
			...
			<div class="count_box">이벤트 종료까지 <span class="remaining-time"></span></div>
			<!-- 시침 -->
        ...
        <div class="question_container">
			...
			<div class="img-area" style="padding: 0 5%;"><img src="//static.resta.co.kr/event/v_${eventSeq}/popup_02.png"></div>
				<div class="question">
...
<script> 
	...
	$(document).ready(function () {
		...
		function updateRemainingTime() {
		    ...
		    // 남은 시간을 표시
		    $('.remaining-time').text(remainingDays + '일 ' + formattedHours + ':' + formattedMinutes)
		}
