...
/* 신청자 수 CSS */
.remaining-box {margin-top: 1.5em; display: flex; align-items: center; justify-content: center; text-align: center; gap: 1em; border-radius: 0.7em; color: #000;}
.remaining-box .person_img {width: 2em;}
.remaining-box .remaining-text {font-size: 2em; font-weight: 600; line-height: 1;}
.remaining-box .remaining-text .remaining-num {color: #5dff87;}
							...
							<div class="table_box rowBorder">
								<table>
									<tbody>
										...
										<input type="hidden" id="branch" name="branch" required="" value="gangnam">
									</tbody>
								</table>
							</div>
						</div>
