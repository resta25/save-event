            ...
            <div class="wrap_form">
                <form class="wrap_curd" id="form-1" method="POST" accept-charset="utf-8">
                    ...
                    <ul class="layout_add02">
                        <li>
                            <label><input type="radio" name="tadd1" value="여드름/흉터/모공 개선" class="answer">여드름/흉터/모공 개선</label>
                            <label><input type="radio" name="tadd1" value="홍조/색소침착 개선" class="answer">홍조/색소침착 개선</label>
                            <label><input type="radio" name="tadd1" value="탄력/주름 개선" class="answer">탄력/주름 개선</label>
